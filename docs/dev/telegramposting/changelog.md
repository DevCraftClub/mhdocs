...
tags:
  ...
  - Плагин
  - Устарело
title: "Изменения в версиях - Telegram Posting"
description: "Документация по плагину изменения в версиях для DLE."
keywords: "PHP, DLE, Плагин, Устарело, изменения в версиях, DevCraft, документация"
author: "Maxim Harder"
og:title: "Изменения в версиях"
og:description: "Документация по плагину изменения в версиях для DLE."
og:image: "https://devcraft.club/data/assets/logo_default/devcraftx2.png"
twitter:title: "Изменения в версиях"
twitter:description: "Документация по плагину изменения в версиях для DLE."
---
