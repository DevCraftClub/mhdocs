...
| {{ static_image }}                          | Случайное изображение из библиотеки «Файлы → Изображения»                                                                                                                  |
| {{ static_file }}                           | Случайный файл из библиотеки «Файлы → Файлы»                                                                                                                               |
| {{ static_audio }}                          | Случайное аудио из библиотеки                                                                                                                                              |
| {{ static_video }}                          | Случайное видео из библиотеки                                                                                                                                              |
