...
AJAX-запросы обрабатываются через `devcraft/ajax.php` (см. [Точки входа](reference/back-end/entry_points.md)).
...
3. При необходимости включите логирование и Telegram-уведомления (см. [Настройка](guides/manage.md)).
...
- [Настройка](guides/manage.md)
- [Точки входа для разработчиков](reference/back-end/entry_points.md)
- [Composer](../../../instructions/composer.md)
