...
Точный набор файлов зависит от шаблона генератора (см. `ModuleGeneratorService` и `ModuleGeneratorInput` в [справочнике API](../reference/back-end/classes/ModuleGeneratorService.md)).
...
- [Класс ModuleGeneratorService](../reference/back-end/classes/ModuleGeneratorService.md)
