...
В шаблонах доступны **теги новости DLE** (`{title}`, `{full-link}`, … — через [`ParseTemplateTags`](../devcraft_admin/backend/classes/ParseTemplateTags.md)) и модульные плейсхолдеры:
