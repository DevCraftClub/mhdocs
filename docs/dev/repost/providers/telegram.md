...
Токен равносилен паролю: не светите его в публичных репозиториях и шаблонах. Подробный разбор (скриншоты): [legacy Telegram Posting → настройка бота](../../telegramposting/bot.md). Официально: [Telegram Bots](https://core.telegram.org/bots), [Bot API](https://core.telegram.org/bots/api).
...
См. также [../connections.md](../connections.md).
