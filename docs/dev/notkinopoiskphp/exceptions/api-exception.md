...
tags:
  ...
  - API
  - Исключения
title: "ApiException - KinopoiskUnofficialTech PHP Wrapper"
description: "Документация по apiexception. Часть API wrapper для КиноПоиска."
keywords: "PHP, API, Исключения, apiexception, DevCraft, документация"
author: "Maxim Harder"
og:title: "ApiException"
og:description: "Документация по apiexception. Часть API wrapper для КиноПоиска."
og:image: "https://devcraft.club/data/assets/logo_default/devcraftx2.png"
twitter:title: "ApiException"
twitter:description: "Документация по apiexception. Часть API wrapper для КиноПоиска."
---
