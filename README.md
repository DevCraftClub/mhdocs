...
Статическая сборка документации DevCraft на **Fumadocs + React Router**. Исходники MDX, приложение и CI — в частном репозитории; на GitHub — сайт (ветка `main` после merge PR) и шаблоны `.github` (Issue/PR).

Деплой CI: ветка `deploy/deploy-2026-08-12-11-21` → Pull Request в `main`. GitHub Pages Source = `main`.
...
**Последнее обновление**: 2026-08-12 11:21 UTC
