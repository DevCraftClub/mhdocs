...
## DevCraft Dev Tools [#devcraft-dev-tools]

\`devcraftclub/dev-tools\` is a PHP 8.3 library with two main capabilities:

1. \`AbstractWith\` + \`#[With]\` / \`#[WithItem]\` for fluent builders
2. \`AbstractReflection\` + validation attributes for DTO mapping
...
Run tests from the package root with \`composer test\`.
`,o={contents:[{heading:`devcraft-dev-tools`,content:"`devcraftclub/dev-tools` is a PHP 8.3 library with two main capabilities:"},{heading:`devcraft-dev-tools`,content:"`AbstractWith` + `#[With]` / `#[WithItem]` for fluent builders"},{heading:`devcraft-dev-tools`,content:"`AbstractReflection` + validation attributes for DTO mapping"},{heading:`dto-mapping`,content:"Run tests from the package root with `composer test`."}],headings:[{id:`devcraft-dev-tools`,content:`DevCraft Dev Tools`},{id:`install`,content:`Install`},{id:`fluent-builder`,content:`Fluent builder`},{id:`dto-mapping`,content:`DTO mapping`}]},s=[{depth:2,url:`#devcraft-dev-tools`,title:(0,n.jsx)(n.Fragment,{children:`DevCraft Dev Tools`})},{depth:3,url:`#install`,title:(0,n.jsx)(n.Fragment,{children:`Install`})},{depth:3,url:`#fluent-builder`,title:(0,n.jsx)(n.Fragment,{children:`Fluent builder`})},{depth:3,url:`#dto-mapping`,title:(0,n.jsx)(n.Fragment,{children:`DTO mapping`})}];function c(e){let t={code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.h2,{id:`devcraft-dev-tools`,children:`DevCraft Dev Tools`}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`devcraftclub/dev-tools`}),` is a PHP 8.3 library with two main capabilities:`]}),`
`,(0,n.jsxs)(t.ol,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`AbstractWith`}),` + `,(0,n.jsx)(t.code,{children:`#[With]`}),` / `,(0,n.jsx)(t.code,{children:`#[WithItem]`}),` for fluent builders`]}),`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`AbstractReflection`}),` + validation attributes for DTO mapping`]}),`
`]}),`
...
`,(0,n.jsx)(t.h3,{id:`fluent-builder`,children:`Fluent builder`}),`
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`}`})})]})})}),`
`,(0,n.jsx)(t.h3,{id:`dto-mapping`,children:`DTO mapping`}),`
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`}`})})]})})}),`
`,(0,n.jsxs)(t.p,{children:[`Run tests from the package root with `,(0,n.jsx)(t.code,{children:`composer test`}),`.`]})]})}function l(e={}){let{wrapper:t}=e.components||{};return t?(0,n.jsx)(t,{...e,children:(0,n.jsx)(c,{...e})}):c(e)}export{a as _markdown,l as default,r as frontmatter,i as lastModified,o as structuredData,s as toc};