import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`With`,description:`Маркерный атрибут: виртуальный withPropertyName($value) заменяет значение свойства.`,version:`1.0.1`},i=new Date(1787213191e3),a=`

**Описание:** Маркерный PHP-атрибут для свойства. \`WithHandler\` генерирует метод \`withPropertyName($value)\` (StudlyCase имени свойства), который заменяет значение свойства целиком и возвращает \`$this\`.
...
$query->withPage(3);
\`\`\`
`,o={contents:[{heading:void 0,content:"**Описание:** Маркерный PHP-атрибут для свойства. `WithHandler` генерирует метод `withPropertyName($value)` (StudlyCase имени свойства), который заменяет значение свойства целиком и возвращает `$this`."},{heading:void 0,content:"**Namespace:** `Devcraft\\Attributes`"},{heading:void 0,content:"**Target:** `Attribute::TARGET_PROPERTY`"},{heading:void 0,content:`**С версии:** 1.0.0`},{heading:void 0,content:`**См. также:**`},{heading:void 0,content:`WithItem`},{heading:void 0,content:`WithHandler`},{heading:void 0,content:`AbstractWith`},{heading:void 0,content:`Гайд: атрибуты With`},{heading:void 0,content:`Гайд: Getter и Setter`},{heading:`поведение`,content:`Свойство должно быть non-public, non-static, non-readonly.`},{heading:`поведение`,content:`Ровно один аргумент.`},{heading:`поведение`,content:`Проверка типа — штатная PHP (без string→int coercion).`},{heading:`поведение`,content:"Nullable свойства допускают `null`."}],headings:[{id:`поведение`,content:`Поведение`}]},s=[{depth:2,url:`#поведение`,title:(0,n.jsx)(n.Fragment,{children:`Поведение`})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Описание:`}),` Маркерный PHP-атрибут для свойства. `,(0,n.jsx)(t.code,{children:`WithHandler`}),` генерирует метод `,(0,n.jsx)(t.code,{children:`withPropertyName($value)`}),` (StudlyCase имени свойства), который заменяет значение свойства целиком и возвращает `,(0,n.jsx)(t.code,{children:`$this`}),`.`]}),`
