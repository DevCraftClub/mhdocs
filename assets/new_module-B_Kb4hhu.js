import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Генератор модулей`,description:`Создание нового модуля DevCraft через админ-панель.`},i=new Date(1787834766e3),a=`

**Зачем:** не копировать каталоги руками — за минуту получить \`manifest.php\`, Pages, Ajax и Twig.

**DevCraft Admin → Генератор модулей** (\`NewModulePage\`). \`NewModuleHandler\` + \`ModuleGeneratorService\` создают \`devcraft/src/modules/{Name}/\`.
...
* [Создание модуля вручную](./create_module) — структура файлов, install.xml, AJAX
...
`,o={contents:[{heading:void 0,content:"**Зачем:** не копировать каталоги руками — за минуту получить `manifest.php`, Pages, Ajax и Twig."},{heading:void 0,content:"**DevCraft Admin → Генератор модулей** (`NewModulePage`). `NewModuleHandler` + `ModuleGeneratorService` создают `devcraft/src/modules/{Name}/`."},{heading:`форма`,content:"Укажите отображаемое имя модуля и код (латиница). Обработчик `NewModuleHandler` вызывает `ModuleGeneratorService`, который создаёт структуру под `devcraft/src/modules/{Name}/`."},{heading:`создаваемая-структура`,content:"Точный набор файлов зависит от шаблона генератора (см. `ModuleGeneratorService` и `ModuleGeneratorInput` в справочнике API)."},{heading:`регистрация-в-dle`,content:`После генерации:`},{heading:`регистрация-в-dle`,content:"Проверьте `manifest.php` нового модуля (меню, AJAX, assets)."},{heading:`регистрация-в-dle`,content:`Убедитесь, что модуль появился в меню DLE.`},{heading:`регистрация-в-dle`,content:"При необходимости добавьте запись в менеджер плагинов DLE для отдельного `engine/inc/{mod}.php`."},{heading:`возможные-проблемы`,content:"**Права на запись** — каталог `devcraft/src/modules/` должен быть доступен для PHP."},{heading:`возможные-проблемы`,content:`**Дубликат кода** — транслит модуля должен быть уникальным.`},{heading:`возможные-проблемы`,content:`**Локализация** — сгенерированные фразы добавьте в XLIFF (см. Генератор языковых файлов).`},{heading:`см-также`,content:`Создание модуля вручную — структура файлов, install.xml, AJAX`},{heading:`см-также`,content:`Манифест модуля`},{heading:`см-также`,content:`Класс ModuleGeneratorService`}],headings:[{id:`форма`,content:`Форма`},{id:`создаваемая-структура`,content:`Создаваемая структура`},{id:`регистрация-в-dle`,content:`Регистрация в DLE`},{id:`возможные-проблемы`,content:`Возможные проблемы`},{id:`см-также`,content:`См. также`}]},s=[{depth:2,url:`#форма`,title:(0,n.jsx)(n.Fragment,{children:`Форма`})},{depth:2,url:`#создаваемая-структура`,title:(0,n.jsx)(n.Fragment,{children:`Создаваемая структура`})},{depth:2,url:`#регистрация-в-dle`,title:(0,n.jsx)(n.Fragment,{children:`Регистрация в DLE`})},{depth:2,url:`#возможные-проблемы`,title:(0,n.jsx)(n.Fragment,{children:`Возможные проблемы`})},{depth:2,url:`#см-также`,title:(0,n.jsx)(n.Fragment,{children:`См. также`})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Зачем:`}),` не копировать каталоги руками — за минуту получить `,(0,n.jsx)(t.code,{children:`manifest.php`}),`, Pages, Ajax и Twig.`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`DevCraft Admin → Генератор модулей`}),` (`,(0,n.jsx)(t.code,{children:`NewModulePage`}),`). `,(0,n.jsx)(t.code,{children:`NewModuleHandler`}),` + `,(0,n.jsx)(t.code,{children:`ModuleGeneratorService`}),` создают `,(0,n.jsx)(t.code,{children:`devcraft/src/modules/{Name}/`}),`.`]}),`
...
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.a,{href:`./create_module`,children:`Создание модуля вручную`}),` — структура файлов, install.xml, AJAX`]}),`
