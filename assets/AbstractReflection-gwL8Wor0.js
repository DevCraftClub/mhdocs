import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`AbstractReflection`,description:`Базовый класс DTO: fromArray, toArray, toJson через ReflectionMapper.`,version:`1.0.0`},i=new Date(1788011088e3),a=`
...
**Исключения:** \`ValidationException\` при ошибках обязательных путей.
...
`]}),`
`,(0,n.jsx)(t.h2,{id:`static-fromarrayarray-data-static`,children:(0,n.jsx)(t.code,{children:`static fromArray(array $data): static`})}),`
...
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$data`}),` (array): ассоциативный массив (например decoded JSON)`]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Исключения:`}),` `,(0,n.jsx)(t.code,{children:`ValidationException`}),` при ошибках обязательных путей.`]}),`
`,(0,n.jsx)(t.h2,{id:`toarray-array`,children:(0,n.jsx)(t.code,{children:`toArray(): array`})}),`
...
`,(0,n.jsx)(t.h2,{id:`tojson-string`,children:(0,n.jsx)(t.code,{children:`toJson(): string`})}),`
...
`,(0,n.jsx)(t.h2,{id:`static-setloggerloggerinterface-logger-void`,children:(0,n.jsx)(t.code,{children:`static setLogger(LoggerInterface $logger): void`})}),`
...
`,(0,n.jsx)(t.h2,{id:`static-resetlogger-void`,children:(0,n.jsx)(t.code,{children:`static resetLogger(): void`})}),`
