import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Класс: AbstractEntity`,description:`Документация по плагину класс: abstractentity для DLE.`},i=new Date(1789631874e3),a=`
...
Оставлен для совместимости. Автор (\`creator\` / \`lastEditor\`) заполняется поведениями Cycle (\`CreatedByHook\` / \`UpdatedByHook\`), этот метод их **не** пишет. Источник ID — адаптер [\`CurrentDleUserId\`](CurrentDleUserId): \`$member_id['user_id']&#x60; если > 0, иначе &#x2A;*\`0\`**.
...
`,(0,n.jsxs)(t.p,{children:[`Оставлен для совместимости. Автор (`,(0,n.jsx)(t.code,{children:`creator`}),` / `,(0,n.jsx)(t.code,{children:`lastEditor`}),`) заполняется поведениями Cycle (`,(0,n.jsx)(t.code,{children:`CreatedByHook`}),` / `,(0,n.jsx)(t.code,{children:`UpdatedByHook`}),`), этот метод их `,(0,n.jsx)(t.strong,{children:`не`}),` пишет. Источник ID — адаптер `,(0,n.jsx)(t.a,{href:`CurrentDleUserId`,children:(0,n.jsx)(t.code,{children:`CurrentDleUserId`})}),`: `,(0,n.jsx)(t.code,{children:`$member_id['user_id']`}),` если > 0, иначе `,(0,n.jsx)(t.strong,{children:(0,n.jsx)(t.code,{children:`0`})}),`.`]}),`
