import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`ValidationException`,description:`Исключение гидратации: карта ошибок по dotted property paths.`,version:`1.0.0`},i=new Date(1787223655e3),a=`
...
\`\`\`
`,o={contents:[{heading:void 0,content:"**Описание:** Расширяет `\\InvalidArgumentException`. Бросается `ReflectionMapper`, когда один или несколько обязательных путей свойств не прошли конверсию/валидацию."},{heading:void 0,content:"**Namespace:** `Devcraft\\Exceptions`"},{heading:void 0,content:`**С версии:** 1.0.0`},{heading:void 0,content:`**См. также:**`},{heading:void 0,content:`ReflectionMapper`},{heading:void 0,content:`Гайд: валидация`},{heading:`__constructarray-errors`,content:`**Параметры:**`},{heading:`__constructarray-errors`,content:"`$errors` (`array<string, list<string>>`): ключ — dotted path (`port`, `address.city`)"},{heading:`__constructarray-errors`,content:"Сообщение исключения: `Validation failed for: {keys}`."},{heading:`geterrors-array`,content:"**Описание:** Возвращает ту же карту `array<string, list<string>>`."}],headings:[{id:`__constructarray-errors`,content:"`__construct(array $errors)`"},{id:`geterrors-array`,content:"`getErrors(): array`"}]},s=[{depth:2,url:`#__constructarray-errors`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`__construct(array $errors)`})})},{depth:2,url:`#geterrors-array`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`getErrors(): array`})})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Описание:`}),` Расширяет `,(0,n.jsx)(t.code,{children:`\\InvalidArgumentException`}),`. Бросается `,(0,n.jsx)(t.code,{children:`ReflectionMapper`}),`, когда один или несколько обязательных путей свойств не прошли конверсию/валидацию.`]}),`
...
`]}),`
`,(0,n.jsx)(t.h2,{id:`__constructarray-errors`,children:(0,n.jsx)(t.code,{children:`__construct(array $errors)`})}),`
`,(0,n.jsx)(t.p,{children:(0,n.jsx)(t.strong,{children:`Параметры:`})}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$errors`}),` (`,(0,n.jsx)(t.code,{children:`array<string, list<string>>`}),`): ключ — dotted path (`,(0,n.jsx)(t.code,{children:`port`}),`, `,(0,n.jsx)(t.code,{children:`address.city`}),`)`]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[`Сообщение исключения: `,(0,n.jsx)(t.code,{children:`Validation failed for: {keys}`}),`.`]}),`
`,(0,n.jsx)(t.h2,{id:`geterrors-array`,children:(0,n.jsx)(t.code,{children:`getErrors(): array`})}),`
