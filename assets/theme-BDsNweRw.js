import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Подключение в теме`,description:`Include TagsAdd в fullstory.tpl: css, button, modal, js и теги шаблонов.`,version:`200.3.1`},i=new Date(1789411081e3),a=`

## Введение [#введение]

На полной новости модуль рисует кнопку и окно предложения тегов. Логика include — в \`engine/modules/devcraft/tags_add.php\`; разметка и скрипт — в теме \`templates/{skin}/devcraft/tags_add/\`.

## Предварительные требования [#предварительные-требования]

* [Начало работы](../getting_started)
* [Установка](../install)
* [Настройки](../settings) — хотя бы текст кнопки и права гостей
...
Файлы темы: \`button.tpl\`, \`modal.tpl\`, \`tags_add.css\`, \`tags_add.js\`. Если скин не Default — скопируйте каталог из пакета \`Default\`.
...
Одобрение / отклонение / удаление — диалоги Metro; отклонение с причиной или стандартной из [настроек](../settings).

## Связанные разделы [#связанные-разделы]

* [Настройки](../settings)
* [История изменений](../changelog)
`,o={contents:[{heading:`введение`,content:"На полной новости модуль рисует кнопку и окно предложения тегов. Логика include — в `engine/modules/devcraft/tags_add.php`; разметка и скрипт — в теме `templates/{skin}/devcraft/tags_add/`."},{heading:`предварительные-требования`,content:`Начало работы`},{heading:`предварительные-требования`,content:`Установка`},{heading:`предварительные-требования`,content:`Настройки — хотя бы текст кнопки и права гостей`},{heading:`fullstorytpl`,content:`В шаблон полной новости добавьте:`},{heading:`fullstorytpl`,content:"Параметр `focus`:"},{heading:`fullstorytpl`,content:`Значение`},{heading:`fullstorytpl`,content:`Результат`},{heading:`fullstorytpl`,content:"`css`"},{heading:`fullstorytpl`,content:`Стили модуля`},{heading:`fullstorytpl`,content:"`button`"},{heading:`fullstorytpl`,content:`Кнопка предложения`},{heading:`fullstorytpl`,content:"`modal`"},{heading:`fullstorytpl`,content:`Разметка модального окна`},{heading:`fullstorytpl`,content:"`js`"},{heading:`fullstorytpl`,content:`Скрипт отправки`},{heading:`fullstorytpl`,content:"Файлы темы: `button.tpl`, `modal.tpl`, `tags_add.css`, `tags_add.js`. Если скин не Default — скопируйте каталог из пакета `Default`."},{heading:`buttontpl`,content:`Тег`},{heading:`buttontpl`,content:`Описание`},{heading:`buttontpl`,content:"`{button-label}`"},{heading:`buttontpl`,content:`Текст кнопки из настроек`},{heading:`buttontpl`,content:"`{news-id}`"},{heading:`buttontpl`,content:`ID новости`},{heading:`modaltpl`,content:`Тег`},{heading:`modaltpl`,content:`Описание`},{heading:`modaltpl`,content:"`{news-id}`"},{heading:`modaltpl`,content:`ID новости`},{heading:`modaltpl`,content:"`{button-label}`"},{heading:`modaltpl`,content:`Текст кнопки / заголовок окна`},{heading:`modaltpl`,content:"`{user-hash}`"},{heading:`modaltpl`,content:"`dle_login_hash` для AJAX"},{heading:`modaltpl`,content:`При правке модалки сохраняйте имена полей формы и endpoint AJAX — иначе отправка сломается.`},{heading:`модерация`,content:"Очередь: `?mod=tags_add&action=suggestions`.\\\nОдобрение / отклонение / удаление — диалоги Metro; отклонение с причиной или стандартной из настроек."},{heading:`связанные-разделы`,content:`Настройки`},{heading:`связанные-разделы`,content:`История изменений`}],headings:[{id:`введение`,content:`Введение`},{id:`предварительные-требования`,content:`Предварительные требования`},{id:`fullstorytpl`,content:`fullstory.tpl`},{id:`теги-шаблонов-темы`,content:`Теги шаблонов темы`},{id:`buttontpl`,content:`button.tpl`},{id:`modaltpl`,content:`modal.tpl`},{id:`модерация`,content:`Модерация`},{id:`связанные-разделы`,content:`Связанные разделы`}]},s=[{depth:2,url:`#введение`,title:(0,n.jsx)(n.Fragment,{children:`Введение`})},{depth:2,url:`#предварительные-требования`,title:(0,n.jsx)(n.Fragment,{children:`Предварительные требования`})},{depth:2,url:`#fullstorytpl`,title:(0,n.jsx)(n.Fragment,{children:`fullstory.tpl`})},{depth:2,url:`#теги-шаблонов-темы`,title:(0,n.jsx)(n.Fragment,{children:`Теги шаблонов темы`})},{depth:3,url:`#buttontpl`,title:(0,n.jsx)(n.Fragment,{children:`button.tpl`})},{depth:3,url:`#modaltpl`,title:(0,n.jsx)(n.Fragment,{children:`modal.tpl`})},{depth:2,url:`#модерация`,title:(0,n.jsx)(n.Fragment,{children:`Модерация`})},{depth:2,url:`#связанные-разделы`,title:(0,n.jsx)(n.Fragment,{children:`Связанные разделы`})}];function c(e){let t={a:`a`,br:`br`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,span:`span`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.h2,{id:`введение`,children:`Введение`}),`
`,(0,n.jsxs)(t.p,{children:[`На полной новости модуль рисует кнопку и окно предложения тегов. Логика include — в `,(0,n.jsx)(t.code,{children:`engine/modules/devcraft/tags_add.php`}),`; разметка и скрипт — в теме `,(0,n.jsx)(t.code,{children:`templates/{skin}/devcraft/tags_add/`}),`.`]}),`
...
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.a,{href:`../settings`,children:`Настройки`}),` — хотя бы текст кнопки и права гостей`]}),`
`]}),`
`,(0,n.jsx)(t.h2,{id:`fullstorytpl`,children:`fullstory.tpl`}),`
...
`,(0,n.jsxs)(t.p,{children:[`Файлы темы: `,(0,n.jsx)(t.code,{children:`button.tpl`}),`, `,(0,n.jsx)(t.code,{children:`modal.tpl`}),`, `,(0,n.jsx)(t.code,{children:`tags_add.css`}),`, `,(0,n.jsx)(t.code,{children:`tags_add.js`}),`. Если скин не Default — скопируйте каталог из пакета `,(0,n.jsx)(t.code,{children:`Default`}),`.`]}),`
...
`,`Одобрение / отклонение / удаление — диалоги Metro; отклонение с причиной или стандартной из `,(0,n.jsx)(t.a,{href:`../settings`,children:`настроек`}),`.`]}),`
