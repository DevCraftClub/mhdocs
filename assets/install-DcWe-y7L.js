import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Установка`,description:`Установка плагина, autoload, схема БД и шаблоны темы`,version:`200.1.0`},i=new Date(1789411081e3),a=`
...
## Сателлиты (бандл) [#сателлиты-бандл]

В том же архиве — модули Telegram / дайджест / статистика. После установки основного плагина пункты появляются в админке (или на дашборде DLE Уведомления). Подробно: [Сателлиты](./guides/satellites).
...
`,(0,n.jsx)(t.h2,{id:`сателлиты-бандл`,children:`Сателлиты (бандл)`}),`
`,(0,n.jsxs)(t.p,{children:[`В том же архиве — модули Telegram / дайджест / статистика. После установки основного плагина пункты появляются в админке (или на дашборде DLE Уведомления). Подробно: `,(0,n.jsx)(t.a,{href:`./guides/satellites`,children:`Сателлиты`}),`.`]}),`
