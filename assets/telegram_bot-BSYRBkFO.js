import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r=`/assets/botfather-DHF3GWzF.png`,i=`/assets/bot_commands-CEKW7JNa.png`,a=`/assets/channel_settings_1-B4hcm4i6.png`,o=`/assets/channel_settings_2-Dnn5mW_5.png`,s=`/assets/channel_settings_3-BCtsQKLA.png`,c=`/assets/bot_added-CdiFVZLo.png`,l=`/assets/channel_info-BwNsoOg7.png`,u=`/assets/getmyid-DnokIdJ0.png`,d={title:`Настройка Telegram-бота`,description:`Документация по плагину настройка бота для DLE.`},f=new Date(1787218238e3),p=`
