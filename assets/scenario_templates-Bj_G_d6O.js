import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Шаблоны и теги`,description:`Файлы .tpl темы, сценарии, обёртки, кнопка подписки и inbox`,version:`200.1.0`},i=new Date(1787654208e3),a=`
...
├── wrappers/      обёртка email / ЛС
├── subscribe/     кнопки на сайте
├── item.tpl       строка inbox
├── wall.tpl       стена
...
| {'{unsubscribe-url}'} | HMAC-ссылка отписки для email/ЛС           |
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{children:`├── wrappers/      обёртка email / ЛС`})}),`
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{children:`├── subscribe/     кнопки на сайте`})}),`
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{children:`├── item.tpl       строка inbox`})}),`
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{children:`└── notifications.js`})})]})})}),`
