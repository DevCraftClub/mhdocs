import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Установка`,description:`Установка плагина, autoload, схема БД и шаблоны темы`,version:`200.1.0`},i=new Date(1787750944e3),a=`
...
5. Если активная тема не \`Default\`, скопируйте\\
   ...
   и при необходимости \`templates/Default/notifications.tpl\` (страница \`do=notifications\`).\\
...
`,`и при необходимости `,(0,n.jsx)(t.code,{children:`templates/Default/notifications.tpl`}),` (страница `,(0,n.jsx)(t.code,{children:`do=notifications`}),`).`,(0,n.jsx)(t.br,{}),`
