import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Страница уведомлений`,description:`Отдельная страница списка: index.php?do=notifications и ЧПУ /notifications/`,version:`200.1.0`},i=new Date(1787750944e3),a=`
...
1. \`do=notifications\` → \`engine/modules/devcraft/notifications_page.php\`
2. Шаблон темы \`templates/{тема}/devcraft/notifications/page.tpl\`
3. Внутри — include стены: \`notifications_site.php?focus=wall\`
...
| Заголовок / canonical | задаёт \`notifications_page.php\` | у родителя               |
| Разметка              | обёртка \`notifications.tpl\`     | только блок стены        |
...
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`do=notifications`}),` → `,(0,n.jsx)(t.code,{children:`engine/modules/devcraft/notifications_page.php`})]}),`
`,(0,n.jsxs)(t.li,{children:[`Шаблон темы `,(0,n.jsx)(t.code,{children:`templates/{тема}/devcraft/notifications/page.tpl`})]}),`
`,(0,n.jsxs)(t.li,{children:[`Внутри — include стены: `,(0,n.jsx)(t.code,{children:`notifications_site.php?focus=wall`})]}),`
`]}),`
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{children:`		{include file="engine/modules/devcraft/notifications_site.php?focus=wall"}`})}),`
...
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{}),(0,n.jsxs)(t.th,{children:[`Страница `,(0,n.jsx)(t.code,{children:`do=`})]}),(0,n.jsxs)(t.th,{children:[(0,n.jsx)(t.code,{children:`focus=wall`}),` в профиле`]})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`URL`}),(0,n.jsxs)(t.td,{children:[`свой (`,(0,n.jsx)(t.code,{children:`/notifications/`}),`)`]}),(0,n.jsx)(t.td,{children:`страница профиля / любая`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`Заголовок / canonical`}),(0,n.jsxs)(t.td,{children:[`задаёт `,(0,n.jsx)(t.code,{children:`notifications_page.php`})]}),(0,n.jsx)(t.td,{children:`у родителя`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`Разметка`}),(0,n.jsxs)(t.td,{children:[`обёртка `,(0,n.jsx)(t.code,{children:`notifications.tpl`})]}),(0,n.jsx)(t.td,{children:`только блок стены`})]})]})]}),`
