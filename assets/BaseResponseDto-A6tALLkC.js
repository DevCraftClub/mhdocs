import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`BaseResponseDto`},i=new Date(1787142659e3),a=`
...
`,o={contents:[{heading:void 0,content:`**Описание:** Базовый класс для всех DTO ответов API
Обеспечивает единообразный интерфейс для всех объектов передачи данных ответов,
предоставляя стандартные методы для создания из массива и преобразования в массив.
Все конкретные DTO ответов должны наследоваться от этого класса.`},{heading:void 0,content:`**С версии:** 1.0.0`},{heading:void 0,content:`**Версия:** 1.0.0`},{heading:void 0,content:`**См. также:**`},{heading:void 0,content:"`\\KinopoiskDev\\Responses\\Api\\MovieDocsResponseDto`:"},{heading:void 0,content:"`\\KinopoiskDev\\Responses\\Api\\PersonDocsResponseDto`:"},{heading:void 0,content:"`\\KinopoiskDev\\Responses\\Api\\SearchMovieResponseDto`:"},{heading:`fromarray`,content:`**Описание:** Создает экземпляр DTO из массива данных
Фабричный метод для создания объекта DTO из ассоциативного массива,
полученного из API ответа. Каждый дочерний класс должен реализовать
этот метод в соответствии со своей структурой данных.`},{heading:`fromarray`,content:"**Возвращает:** `static` Экземпляр конкретного DTO класса"},{heading:`toarray`,content:`**Описание:** Преобразует DTO в ассоциативный массив
Метод для сериализации объекта DTO в массив, пригодный для
передачи в JSON или другие форматы. Структура массива должна
соответствовать формату API ответа.`},{heading:`toarray`,content:"**Возвращает:** `array` Ассоциативный массив с данными DTO"}],headings:[{id:`fromarray`,content:"`fromArray()`"},{id:`toarray`,content:"`toArray()`"}]},s=[{depth:2,url:`#fromarray`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`fromArray()`})})},{depth:2,url:`#toarray`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`toArray()`})})}];function c(e){let t={code:`code`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Описание:`}),` Базовый класс для всех DTO ответов API
Обеспечивает единообразный интерфейс для всех объектов передачи данных ответов,
предоставляя стандартные методы для создания из массива и преобразования в массив.
Все конкретные DTO ответов должны наследоваться от этого класса.`]}),`
...
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`\\KinopoiskDev\\Responses\\Api\\SearchMovieResponseDto`}),`:`]}),`
`]}),`
