import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`ИИ-инструменты`,description:`Промпты и инструменты для ИИ-агентов при разработке модулей DevCraft.`},i=new Date(1788011088e3),a=`

**Зачем:** не переписывать правила DevCraft в каждом чате — скопировать промпт и подставить имя модуля.

Промпты для Cursor / Claude. Контекст модуля: [Создание модуля](create_module), [Fluent Types](fluent_types). PHP-правила: [Конституция](../../../../../instructions/constitution).
...
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.a,{href:`create_module`,children:`Создание модуля`})}),`
