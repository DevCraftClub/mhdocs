import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`История изменений`,description:`Релиз 200.1.0: лента на сайте, типизированные подписки, шаблоны темы`,version:`200.1.0`},i=new Date(1788011088e3),a=`
...
`,o={contents:[{heading:void 0,content:`Дублируется во вкладке **История изменений** в админке модуля.`},{heading:void 0,content:`Репозиторий: DLE-Notifications.`},{heading:`20010-2026-08-26`,content:`Первый релиз под DLE 20 и DevCraft Admin.`},{heading:`20010-2026-08-26`,content:`доставка: сайт, почта, ЛС;`},{heading:`20010-2026-08-26`,content:`подписки: новость, категория, автор, тег, доп. поле, все новые материалы;`},{heading:`20010-2026-08-26`,content:`колокольчик с числом непрочитанных и автообновлением;`},{heading:`20010-2026-08-26`,content:"тексты в `.tpl` темы, плейсхолдеры вроде {'{title}'} и {'{full-link}'};"},{heading:`20010-2026-08-26`,content:`подписанная ссылка «Отписаться» в письме;`},{heading:`20010-2026-08-26`,content:`права по группам;`},{heading:`20010-2026-08-26`,content:"упоминания `@ник` в комментариях;"},{heading:`20010-2026-08-26`,content:`сценарии рейтинга новости/комментария, удаления комментария, подписки на пользователя;`},{heading:`20010-2026-08-26`,content:`гайд Include в шаблонах (cat / tag / xfield / user);`},{heading:`20010-2026-08-26`,content:"публичные entrypoint перенесены в `devcraft/src/modules/Notifications/Site/` (`web.php`, `page.php`, `include.php`); параметр подписки в include — `stype` (не `type`)."}],headings:[{id:`20010-2026-08-26`,content:`200.1.0 (2026-08-26)`}]},s=[{depth:2,url:`#20010-2026-08-26`,title:(0,n.jsx)(n.Fragment,{children:`200.1.0 (2026-08-26)`})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[`Дублируется во вкладке `,(0,n.jsx)(t.strong,{children:`История изменений`}),` в админке модуля.`]}),`
