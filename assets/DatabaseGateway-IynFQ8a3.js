import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Класс: DatabaseGateway`,description:`Документация по плагину класс: databasegateway для DLE.`},i=new Date(1789411935e3),a=`
...
* public [databaseManager()](#method_databaseManager)
...
Лениво создаёт ORM. Схему готовит [\`SchemaSyncService::ensureSchemaReady()\`](SchemaSyncService): сначала накат ожидающих файлов, затем при включённом **debug** Admin — \`SyncTables\` без новых файлов, при выключенном — файл изменений только если Cycle нашёл реальное расхождение, сразу накат. Кэш \`cycle_orm_schema.ser\` + подпись Models: без смены сущностей тяжёлая пересборка не идёт.

**С версии:** 171.3.0

**Возвращает:** \`ORM\\ORM\` — Инициализированный ORM.

<span id="method_databaseManager" />

### databaseManager() [#databasemanager]

Возвращает менеджер подключений Cycle **без** создания ORM (для синхронизации схемы).
...
`,(0,n.jsxs)(t.li,{children:[`public `,(0,n.jsx)(t.a,{href:`#method_databaseManager`,children:`databaseManager()`})]}),`
...
`,(0,n.jsxs)(t.p,{children:[`Лениво создаёт ORM. Схему готовит `,(0,n.jsx)(t.a,{href:`SchemaSyncService`,children:(0,n.jsx)(t.code,{children:`SchemaSyncService::ensureSchemaReady()`})}),`: сначала накат ожидающих файлов, затем при включённом `,(0,n.jsx)(t.strong,{children:`debug`}),` Admin — `,(0,n.jsx)(t.code,{children:`SyncTables`}),` без новых файлов, при выключенном — файл изменений только если Cycle нашёл реальное расхождение, сразу накат. Кэш `,(0,n.jsx)(t.code,{children:`cycle_orm_schema.ser`}),` + подпись Models: без смены сущностей тяжёлая пересборка не идёт.`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`С версии:`}),` 171.3.0`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`ORM\\ORM`}),` — Инициализированный ORM.`]}),`
`,(0,n.jsx)(`span`,{id:`method_databaseManager`}),`
`,(0,n.jsx)(t.h3,{id:`databasemanager`,children:`databaseManager()`}),`
`,(0,n.jsxs)(t.p,{children:[`Возвращает менеджер подключений Cycle `,(0,n.jsx)(t.strong,{children:`без`}),` создания ORM (для синхронизации схемы).`]}),`
