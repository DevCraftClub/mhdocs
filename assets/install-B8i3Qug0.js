import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Установка`,description:`Установка плагина, autoload, схема БД и шаблоны темы`,version:`200.1.0`},i=new Date(1787654208e3),a=`
...
6. В **Настройках** включите типы подписок и каналы (сайт / email / ЛС).
...
На сайте блоки не появляются сами: нужны include в шаблонах темы — [вставка в тему](./guides/subscribe_wall). Тексты уведомлений — \`.tpl\` в той же папке, см. [шаблоны и теги](./guides/scenario_templates).

## Если блока нет [#если-блока-нет]

* пользователь не авторизован;
* у группы нет права на подписку / стену / inbox ([права групп](./guides/permissions));
...
`,(0,n.jsxs)(t.li,{children:[`В `,(0,n.jsx)(t.strong,{children:`Настройках`}),` включите типы подписок и каналы (сайт / email / ЛС).`]}),`
`]}),`
...
`,(0,n.jsxs)(t.p,{children:[`На сайте блоки не появляются сами: нужны include в шаблонах темы — `,(0,n.jsx)(t.a,{href:`./guides/subscribe_wall`,children:`вставка в тему`}),`. Тексты уведомлений — `,(0,n.jsx)(t.code,{children:`.tpl`}),` в той же папке, см. `,(0,n.jsx)(t.a,{href:`./guides/scenario_templates`,children:`шаблоны и теги`}),`.`]}),`
`,(0,n.jsx)(t.h2,{id:`если-блока-нет`,children:`Если блока нет`}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsx)(t.li,{children:`пользователь не авторизован;`}),`
`,(0,n.jsxs)(t.li,{children:[`у группы нет права на подписку / стену / inbox (`,(0,n.jsx)(t.a,{href:`./guides/permissions`,children:`права групп`}),`);`]}),`
