import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Класс: PluginContext`,description:`Документация по плагину класс: plugincontext для DLE.`},i=new Date(1789560091e3),a=`
...
<span id="method_cssAssetFiles" />

### cssAssetFiles() [#cssassetfiles]

Возвращает список имён CSS-файлов из секции assets.css манифеста.

**С версии:** 200.4.1

**Возвращает:** \`list<string>\` — Имена файлов относительно Public/. Router кладёт URL в \`module_css_urls\` для [layout.twig](../../front-end/templates).
...
`,(0,n.jsx)(`span`,{id:`method_cssAssetFiles`}),`
`,(0,n.jsx)(t.h3,{id:`cssassetfiles`,children:`cssAssetFiles()`}),`
`,(0,n.jsx)(t.p,{children:`Возвращает список имён CSS-файлов из секции assets.css манифеста.`}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`С версии:`}),` 200.4.1`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`list<string>`}),` — Имена файлов относительно Public/. Router кладёт URL в `,(0,n.jsx)(t.code,{children:`module_css_urls`}),` для `,(0,n.jsx)(t.a,{href:`../../front-end/templates`,children:`layout.twig`}),`.`]}),`
