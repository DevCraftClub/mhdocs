import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Типы подписок`,description:`news, cat, user, tag, xfield, all: объект подписки и момент срабатывания`,version:`200.1.0`},i=new Date(1787654208e3),a=`

Подписка — пара \`subscription_type\` + \`subscription_id\` (всегда строка). Совпадение с событием ищет matcher; дальше работают права, prefs и каналы.
...
\`\`\`
{include file="engine/modules/devcraft/notifications_site.php?focus=subscribe&type=cat&id={category-id}"}
\`\`\`

Все новости:

\`\`\`
{include file="engine/modules/devcraft/notifications_site.php?focus=subscribe&type=all"}
\`\`\`

Число подписчиков в кнопке — {'{count}'} в \`subscribe/*.tpl\`.
