import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Публичные ресурсы оболочки`,description:`Теги {devcraft*}, siteAssets, страницы Admin, синк в БД и компрессия.`,version:`200.4.1`},i=new Date(1789411935e3),a=`
...
Коды проверки сайта у поисковиков (\`google-site-verification\`, Яндекс и т.п.) добавляйте здесь, а не отдельным плагином. Старый [Webmaster Verification](/dev/dle/simple/webmaster-verification) устарел.
...
`]}),`
`,(0,n.jsxs)(t.p,{children:[`Коды проверки сайта у поисковиков (`,(0,n.jsx)(t.code,{children:`google-site-verification`}),`, Яндекс и т.п.) добавляйте здесь, а не отдельным плагином. Старый `,(0,n.jsx)(t.a,{href:`/dev/dle/simple/webmaster-verification`,children:`Webmaster Verification`}),` устарел.`]}),`
