import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Установка`,description:`Установка DB Manager 200.1.4 для DLE 20.0 с DevCraft Admin.`},i=new Date(1789554716e3),a=`
...
## История изменений (200.1.4) [#история-изменений-20014]

* Манифест и журнал изменений переведены на fluent \`ModuleManifestBuilder\` / \`ChangelogBuilder\`.
...
`,(0,n.jsx)(t.h2,{id:`история-изменений-20014`,children:`История изменений (200.1.4)`}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[`Манифест и журнал изменений переведены на fluent `,(0,n.jsx)(t.code,{children:`ModuleManifestBuilder`}),` / `,(0,n.jsx)(t.code,{children:`ChangelogBuilder`}),`.`]}),`
`]}),`
