import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Начало работы`,description:`Что такое TagsAdd: предложение тегов к новостям, модерация, настройки и подключение в теме.`,version:`200.3.1`},i=new Date(1789477657e3),a=`
...
* Кнопка и модальное окно на полной новости (шаблоны темы).
  ...
  <Folder name="корень сайта DLE">
    <Folder name="devcraft">
      <Folder name="src/modules/TagsAdd">
        ...
        <Folder name="Public — ресурсы модуля" />
      </Folder>
    ...
    <Folder name="engine">
      ...
      <Folder name="modules/devcraft">
        <File name="tags_add.php — include для fullstory (focus=…)" />
      </Folder>
    </Folder>
    ...
    <Folder name="templates/{skin}/devcraft/tags_add">
      ...
      <File name="tags_add.css / tags_add.js" />
    </Folder>
  </Folder>
</Files>
...
* **\`devcraft/src/modules/TagsAdd/\`** — админка и бизнес-логика.
* **\`engine/modules/devcraft/tags_add.php\`** — вывод кнопки/модалки на новости.
* **\`templates/…/tags_add/\`** — вёрстка и скрипт темы.
...
<Steps>
  ...
  <Step>
    ...
    В \`fullstory.tpl\` добавьте includes с \`focus=css|button|modal|js\`. Скопируйте шаблоны в свой скин при необходимости. См. [Подключение в теме](guides/theme).
  </Step>
...
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsx)(t.li,{children:`Кнопка и модальное окно на полной новости (шаблоны темы).`}),`
...
`,(0,n.jsx)(o,{children:(0,n.jsxs)(s,{name:`корень сайта DLE`,defaultOpen:!0,children:[(0,n.jsxs)(s,{name:`devcraft`,defaultOpen:!0,children:[(0,n.jsxs)(s,{name:`src/modules/TagsAdd`,defaultOpen:!0,children:[(0,n.jsx)(a,{name:`manifest.php — меню, AJAX, meta`}),(0,n.jsx)(a,{name:`settings.schema.php — форма настроек`}),(0,n.jsx)(a,{name:`changelog.data.php — история в панели`}),(0,n.jsx)(s,{name:`Pages — главная, очередь, настройки, шаблоны ЛС…`}),(0,n.jsx)(s,{name:`Ajax — suggest, approve, reject, delete…`}),(0,n.jsx)(s,{name:`Services / Models / Repositories / Filter`}),(0,n.jsx)(s,{name:`templates — Twig экранов админки`}),(0,n.jsx)(s,{name:`Public — ресурсы модуля`})]}),(0,n.jsx)(s,{name:`config — tags_add.json после сохранения`}),(0,n.jsx)(s,{name:`locales — tagsadd.xliff (ru_RU, …)`})]}),(0,n.jsxs)(s,{name:`engine`,defaultOpen:!0,children:[(0,n.jsx)(s,{name:`inc`,defaultOpen:!0,children:(0,n.jsx)(a,{name:`tags_add.php — glue админки`})}),(0,n.jsx)(s,{name:`modules/devcraft`,defaultOpen:!0,children:(0,n.jsx)(a,{name:`tags_add.php — include для fullstory (focus=…)`})})]}),(0,n.jsxs)(s,{name:`templates/{skin}/devcraft/tags_add`,defaultOpen:!0,children:[(0,n.jsx)(a,{name:`button.tpl / modal.tpl`}),(0,n.jsx)(a,{name:`tags_add.css / tags_add.js`})]})]})}),`
`,(0,n.jsx)(t.p,{children:`Кратко:`}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.strong,{children:(0,n.jsx)(t.code,{children:`devcraft/src/modules/TagsAdd/`})}),` — админка и бизнес-логика.`]}),`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.strong,{children:(0,n.jsx)(t.code,{children:`engine/modules/devcraft/tags_add.php`})}),` — вывод кнопки/модалки на новости.`]}),`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.strong,{children:(0,n.jsx)(t.code,{children:`templates/…/tags_add/`})}),` — вёрстка и скрипт темы.`]}),`
`]}),`
`,(0,n.jsx)(t.h2,{id:`быстрый-старт`,children:`Быстрый старт`}),`
`,(0,n.jsxs)(l,{children:[(0,n.jsxs)(c,{children:[(0,n.jsx)(t.h3,{id:`поставьте-admin-и-tagsadd`,children:`Поставьте Admin и TagsAdd`}),(0,n.jsxs)(t.p,{children:[`Сначала `,(0,n.jsx)(t.a,{href:`/dev/dle/devcraft_admin/200.4.1/install`,children:`DevCraft Admin`}),`, затем ZIP TagsAdd через менеджер плагинов. В `,(0,n.jsx)(t.code,{children:`devcraft/`}),` выполните `,(0,n.jsx)(t.code,{children:`composer dump-autoload`}),`. Подробности: `,(0,n.jsx)(t.a,{href:`./install`,children:`Установка`}),`.`]})]}),(0,n.jsxs)(c,{children:[(0,n.jsx)(t.h3,{id:`настройки`,children:`Настройки`}),(0,n.jsxs)(t.p,{children:[`Откройте `,(0,n.jsx)(t.code,{children:`?mod=tags_add`}),`, сохраните получателя ЛС, текст кнопки и куда вставлять теги при одобрении. См. `,(0,n.jsx)(t.a,{href:`./settings`,children:`Настройки`}),`.`]})]}),(0,n.jsxs)(c,{children:[(0,n.jsx)(t.h3,{id:`тема`,children:`Тема`}),(0,n.jsxs)(t.p,{children:[`В `,(0,n.jsx)(t.code,{children:`fullstory.tpl`}),` добавьте includes с `,(0,n.jsx)(t.code,{children:`focus=css|button|modal|js`}),`. Скопируйте шаблоны в свой скин при необходимости. См. `,(0,n.jsx)(t.a,{href:`guides/theme`,children:`Подключение в теме`}),`.`]})]}),(0,n.jsxs)(c,{children:[(0,n.jsx)(t.h3,{id:`модерация`,children:`Модерация`}),(0,n.jsxs)(t.p,{children:[`Очередь: `,(0,n.jsx)(t.code,{children:`?mod=tags_add&action=suggestions`}),`. Одобрение пишет теги в новость; отклонение может с причиной (или стандартной из настроек).`]})]})]}),`
`,(0,n.jsx)(t.h2,{id:`руководства-и-разделы`,children:`Руководства и разделы`}),`
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Страница`}),(0,n.jsx)(t.th,{children:`О чём`})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`./install`,children:`Установка`})}),(0,n.jsx)(t.td,{children:`ZIP, Composer, первый запуск, отличие от legacy`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`./settings`,children:`Настройки`})}),(0,n.jsx)(t.td,{children:`PM, xfield prefs, куда писать теги, шаблоны ЛС`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`guides/theme`,children:`Подключение в теме`})}),(0,n.jsx)(t.td,{children:`Includes в fullstory, теги button/modal`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`./changelog`,children:`История изменений`})}),(0,n.jsx)(t.td,{children:`200.3.1 и ранее`})]})]})]}),`
`,(0,n.jsxs)(i,{children:[(0,n.jsx)(r,{title:`Установка`,href:`./install`,children:(0,n.jsx)(t.p,{children:`Admin, ZIP, dump-autoload, таблица`})}),(0,n.jsx)(r,{title:`Настройки`,href:`./settings`,children:(0,n.jsx)(t.p,{children:`Уведомления, вставка тегов, PM`})}),(0,n.jsx)(r,{title:`Тема`,href:`./guides/theme`,children:(0,n.jsx)(t.p,{children:`fullstory.tpl и шаблоны кнопки`})}),(0,n.jsx)(r,{title:`Changelog`,href:`./changelog`,children:(0,n.jsx)(t.p,{children:`Что изменилось в 200.3.1`})})]}),`
