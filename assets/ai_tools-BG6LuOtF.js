import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Справочник: ИИ-инструменты`,description:`Единая точка входа: skills, MCP, Cursor-rules, update-policy и промпт модуля DevCraft.`,version:`200.4.1`},i=new Date(1789555699e3),a=`
...
| Skill                   | Зачем                                     | Ссылка                                                            |
| ----------------------- | ----------------------------------------- | ----------------------------------------------------------------- |
| using-superpowers       | Проверить skills до действий              | [полный текст](../development_help/skills/using-superpowers)      |
| grill-with-docs         | Интервью + словарь/ADR                    | [полный текст](../development_help/skills/grill-with-docs)        |
| create-devcraft-plugin  | Создание / перенос / обновление сателлита | [полный текст](../development_help/skills/create-devcraft-plugin) |
| caveman (skill)         | Краткая речь; не путать с MCP compress    | [полный текст](../development_help/skills/caveman)                |
| codebase-memory (skill) | Граф кода: search\\_graph / trace\\_path    | [полный текст](../development_help/skills/codebase-memory)        |

Подключение: каталог \`.cursor/skills/\` в host-проекте. На страницах Skills — **полное** содержимое \`SKILL.md\`, не краткая выжимка. Обзор: [Skills](../development_help/skills).
...
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Skill`}),(0,n.jsx)(t.th,{children:`Зачем`}),(0,n.jsx)(t.th,{children:`Ссылка`})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`using-superpowers`}),(0,n.jsx)(t.td,{children:`Проверить skills до действий`}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`../development_help/skills/using-superpowers`,children:`полный текст`})})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`grill-with-docs`}),(0,n.jsx)(t.td,{children:`Интервью + словарь/ADR`}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`../development_help/skills/grill-with-docs`,children:`полный текст`})})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`create-devcraft-plugin`}),(0,n.jsx)(t.td,{children:`Создание / перенос / обновление сателлита`}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`../development_help/skills/create-devcraft-plugin`,children:`полный текст`})})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`caveman (skill)`}),(0,n.jsx)(t.td,{children:`Краткая речь; не путать с MCP compress`}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`../development_help/skills/caveman`,children:`полный текст`})})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`codebase-memory (skill)`}),(0,n.jsx)(t.td,{children:`Граф кода: search_graph / trace_path`}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.a,{href:`../development_help/skills/codebase-memory`,children:`полный текст`})})]})]})]}),`
`,(0,n.jsxs)(t.p,{children:[`Подключение: каталог `,(0,n.jsx)(t.code,{children:`.cursor/skills/`}),` в host-проекте. На страницах Skills — `,(0,n.jsx)(t.strong,{children:`полное`}),` содержимое `,(0,n.jsx)(t.code,{children:`SKILL.md`}),`, не краткая выжимка. Обзор: `,(0,n.jsx)(t.a,{href:`../development_help/skills`,children:`Skills`}),`.`]}),`
