import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Reflection mapper`,description:`DTO hydration and serialization with AbstractReflection and ReflectionMapper.`,version:`1.1.0`},i=new Date(1788011088e3),a=`
...
Canonical Proxy / Address sample:
...
## AbstractReflection API [#abstractreflection-api]
...
### Scalar conversion [#scalar-conversion]
...
## Direct mapper use [#direct-mapper-use]
...
* [Changelog](../changelog)
`,o={contents:[{heading:void 0,content:"`AbstractReflection` is the base class for DTOs with public typed properties. It exposes `fromArray()`, `toArray()`, and `toJson()`. Hydration and serialization are implemented by `ReflectionMapper`."},{heading:`quick-start`,content:`Canonical Proxy / Address sample:`},{heading:`abstractreflection-api`,content:`Method`},{heading:`abstractreflection-api`,content:`Description`},{heading:`abstractreflection-api`,content:"`static fromArray(array $data): static`"},{heading:`abstractreflection-api`,content:`Create an instance and hydrate public properties`},{heading:`abstractreflection-api`,content:"`toArray(): array`"},{heading:`abstractreflection-api`,content:`Export initialized public properties (nested DTOs recursively)`},{heading:`abstractreflection-api`,content:"`toJson(): string`"},{heading:`abstractreflection-api`,content:"Pretty-printed JSON with Unicode and slashes unescaped; throws `JsonException` on failure"},{heading:`abstractreflection-api`,content:"`static setLogger(LoggerInterface $logger): void`"},{heading:`abstractreflection-api`,content:`Override the logger used for validation failures`},{heading:`abstractreflection-api`,content:"`static resetLogger(): void`"},{heading:`abstractreflection-api`,content:`Clear the custom logger (tests / teardown)`},{heading:`abstractreflection-api`,content:`Only **public, non-static** properties participate in mapping. Private/protected fields are ignored by the mapper.`},{heading:`hydration-rules`,content:"`ReflectionMapper::hydrate($target, $data)` walks public properties:"},{heading:`hydration-rules`,content:"Missing keys or explicit `null` trigger the null fallback."},{heading:`hydration-rules`,content:`Values are converted according to the property type.`},{heading:`hydration-rules`,content:"`#[ArrayOf]` post-processes list properties."},{heading:`hydration-rules`,content:`Validation attributes run on the converted value.`},{heading:`hydration-rules`,content:"Failures are logged and collected; after the pass, a non-empty error map raises `ValidationException`."},{heading:`scalar-conversion`,content:`Declared type`},{heading:`scalar-conversion`,content:`Accepted input`},{heading:`scalar-conversion`,content:"`string`"},{heading:`scalar-conversion`,content:`string only`},{heading:`scalar-conversion`,content:"`int`"},{heading:`scalar-conversion`,content:"int, or numeric string via `FILTER_VALIDATE_INT`"},{heading:`scalar-conversion`,content:"`float`"},{heading:`scalar-conversion`,content:"float, int, or numeric string via `FILTER_VALIDATE_FLOAT`"},{heading:`scalar-conversion`,content:"`bool`"},{heading:`scalar-conversion`,content:"bool, `0`/`1`, or boolean strings via `FILTER_VALIDATE_BOOLEAN`"},{heading:`scalar-conversion`,content:"`array`"},{heading:`scalar-conversion`,content:`array`},{heading:`scalar-conversion`,content:"`object`"},{heading:`scalar-conversion`,content:`object`},{heading:`scalar-conversion`,content:"`mixed` / untyped"},{heading:`scalar-conversion`,content:`anything`},{heading:`scalar-conversion`,content:`Union and intersection property types are not supported and fail conversion.`},{heading:`nested-dtos`,content:"If the property type is a subclass of `AbstractReflection` and the input is an array, the mapper instantiates the nested class and hydrates it with a dotted path prefix (`address.city`, `locations.0.city`)."},{heading:`nested-dtos`,content:`If the input is already an instance of the declared type (or interface), it is accepted as-is.`},{heading:`null-fallback`,content:"When a key is missing or the value is `null`:"},{heading:`null-fallback`,content:`properties with a default value keep their default`},{heading:`null-fallback`,content:"nullable properties without a usable value become `null`"},{heading:`null-fallback`,content:"required non-nullable properties without a default record `is required`"},{heading:`null-fallback`,content:"When conversion or validation fails for a **nullable** property, the mapper sets the property to `null` instead of adding that path to the thrown error map (the failure is still logged)."},{heading:`arrayof`,content:"`ArrayOf` is both a conversion hint for the mapper and a `ValidationRule`."},{heading:`arrayof`,content:"During conversion, the property value must be a **list** (`array_is_list`). Each element is converted to the declared type (builtin or nested `AbstractReflection`)."},{heading:`arrayof`,content:"Associative arrays fail with `must be a list`. Element failures appear as `ids.1`, `locations.0.city`, and so on."},{heading:`serialization`,content:"`toArray()` includes only initialized public properties. Nested `AbstractReflection` instances are expanded recursively. Plain arrays are walked element by element."},{heading:`serialization`,content:"`toJson()` encodes `toArray()` with:"},{heading:`serialization`,content:"`JSON_THROW_ON_ERROR`"},{heading:`serialization`,content:"`JSON_UNESCAPED_UNICODE`"},{heading:`serialization`,content:"`JSON_PRETTY_PRINT`"},{heading:`serialization`,content:"`JSON_UNESCAPED_SLASHES`"},{heading:`serialization`,content:"`JSON_INVALID_UTF8_SUBSTITUTE`"},{heading:`logging`,content:"By default `AbstractReflection` uses an `Analog\\Logger`. Call `setLogger()` to capture validation failures in tests or application logging:"},{heading:`logging`,content:"Each failure is logged at error level with context keys `class`, `property` (dotted path), `expected`, and `actual_type`."},{heading:`direct-mapper-use`,content:"You can hydrate an existing object without `fromArray()`:"},{heading:`direct-mapper-use`,content:"An optional second constructor argument accepts a custom `PropertyValidator`."},{heading:`related`,content:`AbstractReflection`},{heading:`related`,content:`ReflectionMapper`},{heading:`related`,content:`ArrayOf`},{heading:`related`,content:`Validation`},{heading:`related`,content:`Changelog`}],headings:[{id:`quick-start`,content:`Quick start`},{id:`abstractreflection-api`,content:`AbstractReflection API`},{id:`hydration-rules`,content:`Hydration rules`},{id:`scalar-conversion`,content:`Scalar conversion`},{id:`nested-dtos`,content:`Nested DTOs`},{id:`null-fallback`,content:`Null fallback`},{id:`arrayof`,content:"`#[ArrayOf]`"},{id:`serialization`,content:`Serialization`},{id:`logging`,content:`Logging`},{id:`direct-mapper-use`,content:`Direct mapper use`},{id:`related`,content:`Related`}]},s=[{depth:2,url:`#quick-start`,title:(0,n.jsx)(n.Fragment,{children:`Quick start`})},{depth:2,url:`#abstractreflection-api`,title:(0,n.jsx)(n.Fragment,{children:`AbstractReflection API`})},{depth:2,url:`#hydration-rules`,title:(0,n.jsx)(n.Fragment,{children:`Hydration rules`})},{depth:3,url:`#scalar-conversion`,title:(0,n.jsx)(n.Fragment,{children:`Scalar conversion`})},{depth:3,url:`#nested-dtos`,title:(0,n.jsx)(n.Fragment,{children:`Nested DTOs`})},{depth:3,url:`#null-fallback`,title:(0,n.jsx)(n.Fragment,{children:`Null fallback`})},{depth:2,url:`#arrayof`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`#[ArrayOf]`})})},{depth:2,url:`#serialization`,title:(0,n.jsx)(n.Fragment,{children:`Serialization`})},{depth:2,url:`#logging`,title:(0,n.jsx)(n.Fragment,{children:`Logging`})},{depth:2,url:`#direct-mapper-use`,title:(0,n.jsx)(n.Fragment,{children:`Direct mapper use`})},{depth:2,url:`#related`,title:(0,n.jsx)(n.Fragment,{children:`Related`})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`AbstractReflection`}),` is the base class for DTOs with public typed properties. It exposes `,(0,n.jsx)(t.code,{children:`fromArray()`}),`, `,(0,n.jsx)(t.code,{children:`toArray()`}),`, and `,(0,n.jsx)(t.code,{children:`toJson()`}),`. Hydration and serialization are implemented by `,(0,n.jsx)(t.code,{children:`ReflectionMapper`}),`.`]}),`
...
`,(0,n.jsx)(t.p,{children:`Canonical Proxy / Address sample:`}),`
...
`,(0,n.jsx)(t.h2,{id:`abstractreflection-api`,children:`AbstractReflection API`}),`
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Method`}),(0,n.jsx)(t.th,{children:`Description`})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`static fromArray(array $data): static`})}),(0,n.jsx)(t.td,{children:`Create an instance and hydrate public properties`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`toArray(): array`})}),(0,n.jsx)(t.td,{children:`Export initialized public properties (nested DTOs recursively)`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`toJson(): string`})}),(0,n.jsxs)(t.td,{children:[`Pretty-printed JSON with Unicode and slashes unescaped; throws `,(0,n.jsx)(t.code,{children:`JsonException`}),` on failure`]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`static setLogger(LoggerInterface $logger): void`})}),(0,n.jsx)(t.td,{children:`Override the logger used for validation failures`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`static resetLogger(): void`})}),(0,n.jsx)(t.td,{children:`Clear the custom logger (tests / teardown)`})]})]})]}),`
`,(0,n.jsxs)(t.p,{children:[`Only `,(0,n.jsx)(t.strong,{children:`public, non-static`}),` properties participate in mapping. Private/protected fields are ignored by the mapper.`]}),`
`,(0,n.jsx)(t.h2,{id:`hydration-rules`,children:`Hydration rules`}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`ReflectionMapper::hydrate($target, $data)`}),` walks public properties:`]}),`
`,(0,n.jsxs)(t.ol,{children:[`
`,(0,n.jsxs)(t.li,{children:[`Missing keys or explicit `,(0,n.jsx)(t.code,{children:`null`}),` trigger the null fallback.`]}),`
`,(0,n.jsx)(t.li,{children:`Values are converted according to the property type.`}),`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`#[ArrayOf]`}),` post-processes list properties.`]}),`
`,(0,n.jsx)(t.li,{children:`Validation attributes run on the converted value.`}),`
`,(0,n.jsxs)(t.li,{children:[`Failures are logged and collected; after the pass, a non-empty error map raises `,(0,n.jsx)(t.code,{children:`ValidationException`}),`.`]}),`
`]}),`
`,(0,n.jsx)(t.h3,{id:`scalar-conversion`,children:`Scalar conversion`}),`
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Declared type`}),(0,n.jsx)(t.th,{children:`Accepted input`})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`string`})}),(0,n.jsx)(t.td,{children:`string only`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`int`})}),(0,n.jsxs)(t.td,{children:[`int, or numeric string via `,(0,n.jsx)(t.code,{children:`FILTER_VALIDATE_INT`})]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`float`})}),(0,n.jsxs)(t.td,{children:[`float, int, or numeric string via `,(0,n.jsx)(t.code,{children:`FILTER_VALIDATE_FLOAT`})]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`bool`})}),(0,n.jsxs)(t.td,{children:[`bool, `,(0,n.jsx)(t.code,{children:`0`}),`/`,(0,n.jsx)(t.code,{children:`1`}),`, or boolean strings via `,(0,n.jsx)(t.code,{children:`FILTER_VALIDATE_BOOLEAN`})]})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`array`})}),(0,n.jsx)(t.td,{children:`array`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`object`})}),(0,n.jsx)(t.td,{children:`object`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsxs)(t.td,{children:[(0,n.jsx)(t.code,{children:`mixed`}),` / untyped`]}),(0,n.jsx)(t.td,{children:`anything`})]})]})]}),`
`,(0,n.jsx)(t.p,{children:`Union and intersection property types are not supported and fail conversion.`}),`
`,(0,n.jsx)(t.h3,{id:`nested-dtos`,children:`Nested DTOs`}),`
`,(0,n.jsxs)(t.p,{children:[`If the property type is a subclass of `,(0,n.jsx)(t.code,{children:`AbstractReflection`}),` and the input is an array, the mapper instantiates the nested class and hydrates it with a dotted path prefix (`,(0,n.jsx)(t.code,{children:`address.city`}),`, `,(0,n.jsx)(t.code,{children:`locations.0.city`}),`).`]}),`
`,(0,n.jsx)(t.p,{children:`If the input is already an instance of the declared type (or interface), it is accepted as-is.`}),`
`,(0,n.jsx)(t.h3,{id:`null-fallback`,children:`Null fallback`}),`
`,(0,n.jsxs)(t.p,{children:[`When a key is missing or the value is `,(0,n.jsx)(t.code,{children:`null`}),`:`]}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsx)(t.li,{children:`properties with a default value keep their default`}),`
`,(0,n.jsxs)(t.li,{children:[`nullable properties without a usable value become `,(0,n.jsx)(t.code,{children:`null`})]}),`
`,(0,n.jsxs)(t.li,{children:[`required non-nullable properties without a default record `,(0,n.jsx)(t.code,{children:`is required`})]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[`When conversion or validation fails for a `,(0,n.jsx)(t.strong,{children:`nullable`}),` property, the mapper sets the property to `,(0,n.jsx)(t.code,{children:`null`}),` instead of adding that path to the thrown error map (the failure is still logged).`]}),`
`,(0,n.jsx)(t.h2,{id:`arrayof`,children:(0,n.jsx)(t.code,{children:`#[ArrayOf]`})}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`ArrayOf`}),` is both a conversion hint for the mapper and a `,(0,n.jsx)(t.code,{children:`ValidationRule`}),`.`]}),`
`,(0,n.jsxs)(t.p,{children:[`During conversion, the property value must be a `,(0,n.jsx)(t.strong,{children:`list`}),` (`,(0,n.jsx)(t.code,{children:`array_is_list`}),`). Each element is converted to the declared type (builtin or nested `,(0,n.jsx)(t.code,{children:`AbstractReflection`}),`).`]}),`
...
`,(0,n.jsxs)(t.span,{className:`line`,children:[(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`#[`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#005CC5`,"--shiki-dark":`#79B8FF`},children:`ArrayOf`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`(`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#005CC5`,"--shiki-dark":`#79B8FF`},children:`Address`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:`::class`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`)]`})]}),`
`,(0,n.jsxs)(t.span,{className:`line`,children:[(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:`public`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:` array`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:` $locations `}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:`=`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:` [];`})]})]})})}),`
`,(0,n.jsxs)(t.p,{children:[`Associative arrays fail with `,(0,n.jsx)(t.code,{children:`must be a list`}),`. Element failures appear as `,(0,n.jsx)(t.code,{children:`ids.1`}),`, `,(0,n.jsx)(t.code,{children:`locations.0.city`}),`, and so on.`]}),`
`,(0,n.jsx)(t.h2,{id:`serialization`,children:`Serialization`}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`toArray()`}),` includes only initialized public properties. Nested `,(0,n.jsx)(t.code,{children:`AbstractReflection`}),` instances are expanded recursively. Plain arrays are walked element by element.`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`toJson()`}),` encodes `,(0,n.jsx)(t.code,{children:`toArray()`}),` with:`]}),`
`,(0,n.jsxs)(t.ul,{children:[`
...
`,(0,n.jsxs)(t.p,{children:[`By default `,(0,n.jsx)(t.code,{children:`AbstractReflection`}),` uses an `,(0,n.jsx)(t.code,{children:`Analog\\Logger`}),`. Call `,(0,n.jsx)(t.code,{children:`setLogger()`}),` to capture validation failures in tests or application logging:`]}),`
...
`,(0,n.jsxs)(t.p,{children:[`Each failure is logged at error level with context keys `,(0,n.jsx)(t.code,{children:`class`}),`, `,(0,n.jsx)(t.code,{children:`property`}),` (dotted path), `,(0,n.jsx)(t.code,{children:`expected`}),`, and `,(0,n.jsx)(t.code,{children:`actual_type`}),`.`]}),`
`,(0,n.jsx)(t.h2,{id:`direct-mapper-use`,children:`Direct mapper use`}),`
`,(0,n.jsxs)(t.p,{children:[`You can hydrate an existing object without `,(0,n.jsx)(t.code,{children:`fromArray()`}),`:`]}),`
...
`,(0,n.jsxs)(t.p,{children:[`An optional second constructor argument accepts a custom `,(0,n.jsx)(t.code,{children:`PropertyValidator`}),`.`]}),`
...
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.a,{href:`validation`,children:`Validation`})}),`
