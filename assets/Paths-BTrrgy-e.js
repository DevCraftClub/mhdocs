import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Класс: Paths`,description:`Документация по плагину класс: paths для DLE.`},i=new Date(1789555699e3),a=`
...
* public [pluginExports()](#method_pluginExports)
...
<span id="method_pluginExports" />

### pluginExports() [#pluginexports]

Возвращает каталог экспорта install.xml / ZIP плагинов для \`PluginPresenter::export()\`.

Берёт настройку Admin \`plugin_exports_path\`; пустое значение — \`DEVCRAFT_CACHE/plugin_exports\`. Относительные пути считаются от \`ROOT_DIR\`.

**С версии:** 200.4.1

**Возвращает:** \`string\` — Абсолютный нормализованный путь к каталогу экспорта.
...
`,o={contents:[{heading:`краткое-содержание`,content:`Регистрация и доступ к путям и URL-адресам DevCraft.`},{heading:`свойства`,content:`*Нет публичных свойств.*`},{heading:`методы`,content:`public register()`},{heading:`методы`,content:`public root()`},{heading:`методы`,content:`public src()`},{heading:`методы`,content:`public templates()`},{heading:`методы`,content:`public locales()`},{heading:`методы`,content:`public config()`},{heading:`методы`,content:`public modules()`},{heading:`методы`,content:`public classes()`},{heading:`методы`,content:`public logs()`},{heading:`методы`,content:`public cache()`},{heading:`методы`,content:`public pluginExports()`},{heading:`методы`,content:`public publicAssets()`},{heading:`методы`,content:`public base()`},{heading:`методы`,content:`public ajaxBase()`},{heading:`методы`,content:`public ajaxUrl()`},{heading:`подробности`,content:"Путь: `devcraft/src/classes/Config/Paths.php`"},{heading:`register`,content:`Регистрирует константы путей DevCraft, если они ещё не определены.`},{heading:`register`,content:`**С версии:** 200.4.0`},{heading:`root`,content:`Возвращает абсолютный путь к корню каталога devcraft/.`},{heading:`root`,content:`**С версии:** 200.4.0`},{heading:`root`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_ROOT."},{heading:`src`,content:`Возвращает абсолютный путь к каталогу devcraft/src/.`},{heading:`src`,content:`**С версии:** 200.4.0`},{heading:`src`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_SRC."},{heading:`templates`,content:`Возвращает абсолютный путь к каталогу шаблонов Twig.`},{heading:`templates`,content:`**С версии:** 200.4.0`},{heading:`templates`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_TEMPLATES."},{heading:`locales`,content:`Возвращает абсолютный путь к каталогу локалей XLIFF.`},{heading:`locales`,content:`**С версии:** 200.4.0`},{heading:`locales`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_LOCALES."},{heading:`config`,content:`Возвращает абсолютный путь к каталогу конфигурации плагина.`},{heading:`config`,content:`**С версии:** 200.4.0`},{heading:`config`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_CONFIG."},{heading:`modules`,content:`Возвращает абсолютный путь к каталогу модулей DevCraft.`},{heading:`modules`,content:`**С версии:** 200.4.0`},{heading:`modules`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_MODULES."},{heading:`classes`,content:`Возвращает абсолютный путь к каталогу PHP-классов DevCraft.`},{heading:`classes`,content:`**С версии:** 200.4.0`},{heading:`classes`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_CLASSES."},{heading:`logs`,content:`Возвращает абсолютный путь к каталогу логов плагина.`},{heading:`logs`,content:`**С версии:** 200.4.0`},{heading:`logs`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_LOGS."},{heading:`cache`,content:`Возвращает абсолютный путь к каталогу кеша плагина.`},{heading:`cache`,content:`**С версии:** 200.4.0`},{heading:`cache`,content:"**Возвращает:** `string` — Значение DEVCRAFT\\_CACHE."},{heading:`pluginexports`,content:"Возвращает каталог экспорта install.xml / ZIP плагинов для `PluginPresenter::export()`."},{heading:`pluginexports`,content:"Берёт настройку Admin `plugin_exports_path`; пустое значение — `DEVCRAFT_CACHE/plugin_exports`. Относительные пути считаются от `ROOT_DIR`."},{heading:`pluginexports`,content:`**С версии:** 200.4.1`},{heading:`pluginexports`,content:"**Возвращает:** `string` — Абсолютный нормализованный путь к каталогу экспорта."},{heading:`publicassets`,content:`Возвращает файловый каталог публичных DevCraft-ресурсов (css/js для AssetsChecker).`},{heading:`publicassets`,content:`**С версии:** 200.4.0`},{heading:`publicassets`,content:"**Возвращает:** `string` — Абсолютный путь к devcraft/src/templates/core/assets/."},{heading:`base`,content:`Возвращает базовый URL сайта DLE без завершающего слэша.`},{heading:`base`,content:`**С версии:** 200.4.0`},{heading:`base`,content:"**Возвращает:** `string` — URL из $config\\['http\\_home\\_url'] или «/»."},{heading:`ajaxbase`,content:"Возвращает базовый URL AJAX-входа DevCraft (`/devcraft/ajax.php`)."},{heading:`ajaxbase`,content:`**С версии:** 200.4.0`},{heading:`ajaxbase`,content:"**Возвращает:** `string` — Полный URL точки входа ajax.php."},{heading:`ajaxurl`,content:`Формирует полный URL AJAX-запроса с параметрами controller и method.`},{heading:`ajaxurl`,content:`**С версии:** 200.4.0`},{heading:`ajaxurl`,content:`**Параметры:**`},{heading:`ajaxurl`,content:"`$method` — Имя AJAX-метода."},{heading:`ajaxurl`,content:"`$controller` — Идентификатор контроллера (по умолчанию «admin»)."},{heading:`ajaxurl`,content:"**Возвращает:** `string` — URL с query-параметрами controller и method."}],headings:[{id:`краткое-содержание`,content:`Краткое содержание:`},{id:`свойства`,content:`Свойства`},{id:`методы`,content:`Методы`},{id:`подробности`,content:`Подробности`},{id:`детали`,content:`Детали`},{id:`методы-1`,content:`Методы`},{id:`register`,content:`register()`},{id:`root`,content:`root()`},{id:`src`,content:`src()`},{id:`templates`,content:`templates()`},{id:`locales`,content:`locales()`},{id:`config`,content:`config()`},{id:`modules`,content:`modules()`},{id:`classes`,content:`classes()`},{id:`logs`,content:`logs()`},{id:`cache`,content:`cache()`},{id:`pluginexports`,content:`pluginExports()`},{id:`publicassets`,content:`publicAssets()`},{id:`base`,content:`base()`},{id:`ajaxbase`,content:`ajaxBase()`},{id:`ajaxurl`,content:`ajaxUrl()`}]},s=[{depth:2,url:`#краткое-содержание`,title:(0,n.jsx)(n.Fragment,{children:`Краткое содержание:`})},{depth:3,url:`#свойства`,title:(0,n.jsx)(n.Fragment,{children:`Свойства`})},{depth:3,url:`#методы`,title:(0,n.jsx)(n.Fragment,{children:`Методы`})},{depth:3,url:`#подробности`,title:(0,n.jsx)(n.Fragment,{children:`Подробности`})},{depth:2,url:`#детали`,title:(0,n.jsx)(n.Fragment,{children:`Детали`})},{depth:3,url:`#методы-1`,title:(0,n.jsx)(n.Fragment,{children:`Методы`})},{depth:3,url:`#register`,title:(0,n.jsx)(n.Fragment,{children:`register()`})},{depth:3,url:`#root`,title:(0,n.jsx)(n.Fragment,{children:`root()`})},{depth:3,url:`#src`,title:(0,n.jsx)(n.Fragment,{children:`src()`})},{depth:3,url:`#templates`,title:(0,n.jsx)(n.Fragment,{children:`templates()`})},{depth:3,url:`#locales`,title:(0,n.jsx)(n.Fragment,{children:`locales()`})},{depth:3,url:`#config`,title:(0,n.jsx)(n.Fragment,{children:`config()`})},{depth:3,url:`#modules`,title:(0,n.jsx)(n.Fragment,{children:`modules()`})},{depth:3,url:`#classes`,title:(0,n.jsx)(n.Fragment,{children:`classes()`})},{depth:3,url:`#logs`,title:(0,n.jsx)(n.Fragment,{children:`logs()`})},{depth:3,url:`#cache`,title:(0,n.jsx)(n.Fragment,{children:`cache()`})},{depth:3,url:`#pluginexports`,title:(0,n.jsx)(n.Fragment,{children:`pluginExports()`})},{depth:3,url:`#publicassets`,title:(0,n.jsx)(n.Fragment,{children:`publicAssets()`})},{depth:3,url:`#base`,title:(0,n.jsx)(n.Fragment,{children:`base()`})},{depth:3,url:`#ajaxbase`,title:(0,n.jsx)(n.Fragment,{children:`ajaxBase()`})},{depth:3,url:`#ajaxurl`,title:(0,n.jsx)(n.Fragment,{children:`ajaxUrl()`})}];function c(e){let t={a:`a`,code:`code`,em:`em`,h2:`h2`,h3:`h3`,hr:`hr`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.h2,{id:`краткое-содержание`,children:`Краткое содержание:`}),`
...
`,(0,n.jsxs)(t.li,{children:[`public `,(0,n.jsx)(t.a,{href:`#method_pluginExports`,children:`pluginExports()`})]}),`
...
`,(0,n.jsx)(`span`,{id:`method_pluginExports`}),`
`,(0,n.jsx)(t.h3,{id:`pluginexports`,children:`pluginExports()`}),`
`,(0,n.jsxs)(t.p,{children:[`Возвращает каталог экспорта install.xml / ZIP плагинов для `,(0,n.jsx)(t.code,{children:`PluginPresenter::export()`}),`.`]}),`
`,(0,n.jsxs)(t.p,{children:[`Берёт настройку Admin `,(0,n.jsx)(t.code,{children:`plugin_exports_path`}),`; пустое значение — `,(0,n.jsx)(t.code,{children:`DEVCRAFT_CACHE/plugin_exports`}),`. Относительные пути считаются от `,(0,n.jsx)(t.code,{children:`ROOT_DIR`}),`.`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`С версии:`}),` 200.4.1`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`string`}),` — Абсолютный нормализованный путь к каталогу экспорта.`]}),`
