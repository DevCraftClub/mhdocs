import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Класс: Application`,description:`Документация по плагину класс: application для DLE.`},i=new Date(1787834766e3),a=`
...
> Загрузка строк DLE — static [\`DataLoaderService\`](./DataLoaderService) / [\`DleDataService\`](./DleDataService) (методы \`dataLoader()\` / \`dleData()\` удалены).
...
`,o={contents:[{heading:`краткое-содержание`,content:`Главный контейнер приложения DevCraft (Singleton).`},{heading:`свойства`,content:`private $instance`},{heading:`свойства`,content:`private $registry`},{heading:`свойства`,content:`private $twig`},{heading:`свойства`,content:`private $database`},{heading:`свойства`,content:`private $assetsChecker`},{heading:`методы`,content:`private \\_\\_construct()`},{heading:`методы`,content:`public instance()`},{heading:`методы`,content:`public boot()`},{heading:`методы`,content:`public registry()`},{heading:`методы`,content:`public twig()`},{heading:`методы`,content:`public database()`},{heading:`методы`,content:`public runAdmin()`},{heading:`методы`,content:`public assetsChecker()`},{heading:`методы`,content:`public public\\_asset\\_url()`},{heading:`методы`,content:`public modulePublicAssetUrl()`},{heading:`подробности`,content:"Путь: `devcraft/src/classes/Application.php`"},{heading:`instance`,content:`Главный контейнер приложения DevCraft (Singleton).`},{heading:`registry`,content:`Признак завершённой инициализации ядра.`},{heading:`twig`,content:`Экземпляр Twig для рендеринга шаблонов.`},{heading:`database`,content:`Шлюз доступа к базе данных через Cycle ORM.`},{heading:`assetschecker`,content:`Сервис проверки целостности публичных ассетов.`},{heading:`__construct`,content:`Закрывает прямое создание экземпляра; используйте \\{@see instance()}.`},{heading:`__construct`,content:`**С версии:** 200.4.0`},{heading:`instance-1`,content:`Возвращает единственный экземпляр приложения DevCraft.`},{heading:`instance-1`,content:`**С версии:** 200.4.0`},{heading:`instance-1`,content:"**Возвращает:** `self` — Экземпляр приложения."},{heading:`boot`,content:`Выполняет однократную инициализацию путей, реестра модулей и Twig.`},{heading:`boot`,content:`**С версии:** 200.4.0`},{heading:`registry-1`,content:`Возвращает реестр модулей после автоматической инициализации ядра.`},{heading:`registry-1`,content:`**С версии:** 200.4.0`},{heading:`registry-1`,content:"**Возвращает:** `Registry` — Реестр активных модулей."},{heading:`twig-1`,content:`Возвращает окружение Twig с подключённым расширением перевода.`},{heading:`twig-1`,content:`**С версии:** 200.4.0`},{heading:`twig-1`,content:"**Возвращает:** `Environment` — Настроенный экземпляр Twig."},{heading:`database-1`,content:`Возвращает шлюз базы данных, создавая его при первом обращении.`},{heading:`database-1`,content:`**С версии:** 200.4.0`},{heading:`database-1`,content:"**Возвращает:** `DatabaseGateway` — Шлюз Cycle ORM для DevCraft."},{heading:`runadmin`,content:`Запускает обработку запроса админ-модуля DevCraft.`},{heading:`runadmin`,content:`**С версии:** 200.4.0`},{heading:`runadmin`,content:`**Параметры:**`},{heading:`runadmin`,content:"`$moduleDir` — Имя каталога модуля относительно DEVCRAFT\\_MODULES."},{heading:`runadmin`,content:"`$mod` — Переопределение идентификатора модуля в URL (необязательно)."},{heading:`runadmin`,content:"> Загрузка строк DLE — static `DataLoaderService` / `DleDataService` (методы `dataLoader()` / `dleData()` удалены)."},{heading:`assetschecker-1`,content:`Возвращает сервис проверки публичных ассетов DevCraft.`},{heading:`assetschecker-1`,content:`**С версии:** 200.4.0`},{heading:`assetschecker-1`,content:"**Возвращает:** `AssetsCheckerService` — Сервис AssetsChecker."},{heading:`public_asset_url`,content:`Возвращает публичный URL каталога core/assets шаблонов DevCraft.`},{heading:`public_asset_url`,content:`**С версии:** 200.4.0`},{heading:`public_asset_url`,content:"**Возвращает:** `string` — URL с завершающим слэшем."},{heading:`modulepublicasseturl`,content:`Возвращает базовый URL каталога Public модуля (JS/CSS из manifest assets).`},{heading:`modulepublicasseturl`,content:`**С версии:** 200.4.0`},{heading:`modulepublicasseturl`,content:`**Параметры:**`},{heading:`modulepublicasseturl`,content:"`$modulePath` — Абсолютный путь к корню модуля."},{heading:`modulepublicasseturl`,content:"**Возвращает:** `string` — URL каталога Public с завершающим слэшем."}],headings:[{id:`краткое-содержание`,content:`Краткое содержание:`},{id:`свойства`,content:`Свойства`},{id:`методы`,content:`Методы`},{id:`подробности`,content:`Подробности`},{id:`детали`,content:`Детали`},{id:`свойства-1`,content:`Свойства`},{id:`instance`,content:`$instance`},{id:`registry`,content:`$registry`},{id:`twig`,content:`$twig`},{id:`database`,content:`$database`},{id:`assetschecker`,content:`$assetsChecker`},{id:`методы-1`,content:`Методы`},{id:`__construct`,content:`\\__construct()`},{id:`instance-1`,content:`instance()`},{id:`boot`,content:`boot()`},{id:`registry-1`,content:`registry()`},{id:`twig-1`,content:`twig()`},{id:`database-1`,content:`database()`},{id:`runadmin`,content:`runAdmin()`},{id:`assetschecker-1`,content:`assetsChecker()`},{id:`public_asset_url`,content:`public_asset_url()`},{id:`modulepublicasseturl`,content:`modulePublicAssetUrl()`}]},s=[{depth:2,url:`#краткое-содержание`,title:(0,n.jsx)(n.Fragment,{children:`Краткое содержание:`})},{depth:3,url:`#свойства`,title:(0,n.jsx)(n.Fragment,{children:`Свойства`})},{depth:3,url:`#методы`,title:(0,n.jsx)(n.Fragment,{children:`Методы`})},{depth:3,url:`#подробности`,title:(0,n.jsx)(n.Fragment,{children:`Подробности`})},{depth:2,url:`#детали`,title:(0,n.jsx)(n.Fragment,{children:`Детали`})},{depth:3,url:`#свойства-1`,title:(0,n.jsx)(n.Fragment,{children:`Свойства`})},{depth:4,url:`#instance`,title:(0,n.jsx)(n.Fragment,{children:`$instance`})},{depth:4,url:`#registry`,title:(0,n.jsx)(n.Fragment,{children:`$registry`})},{depth:4,url:`#twig`,title:(0,n.jsx)(n.Fragment,{children:`$twig`})},{depth:4,url:`#database`,title:(0,n.jsx)(n.Fragment,{children:`$database`})},{depth:4,url:`#assetschecker`,title:(0,n.jsx)(n.Fragment,{children:`$assetsChecker`})},{depth:3,url:`#методы-1`,title:(0,n.jsx)(n.Fragment,{children:`Методы`})},{depth:3,url:`#__construct`,title:(0,n.jsx)(n.Fragment,{children:`__construct()`})},{depth:3,url:`#instance-1`,title:(0,n.jsx)(n.Fragment,{children:`instance()`})},{depth:3,url:`#boot`,title:(0,n.jsx)(n.Fragment,{children:`boot()`})},{depth:3,url:`#registry-1`,title:(0,n.jsx)(n.Fragment,{children:`registry()`})},{depth:3,url:`#twig-1`,title:(0,n.jsx)(n.Fragment,{children:`twig()`})},{depth:3,url:`#database-1`,title:(0,n.jsx)(n.Fragment,{children:`database()`})},{depth:3,url:`#runadmin`,title:(0,n.jsx)(n.Fragment,{children:`runAdmin()`})},{depth:3,url:`#assetschecker-1`,title:(0,n.jsx)(n.Fragment,{children:`assetsChecker()`})},{depth:3,url:`#public_asset_url`,title:(0,n.jsx)(n.Fragment,{children:`public_asset_url()`})},{depth:3,url:`#modulepublicasseturl`,title:(0,n.jsx)(n.Fragment,{children:`modulePublicAssetUrl()`})}];function c(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,hr:`hr`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.h2,{id:`краткое-содержание`,children:`Краткое содержание:`}),`
...
`,(0,n.jsxs)(t.p,{children:[`Загрузка строк DLE — static `,(0,n.jsx)(t.a,{href:`./DataLoaderService`,children:(0,n.jsx)(t.code,{children:`DataLoaderService`})}),` / `,(0,n.jsx)(t.a,{href:`./DleDataService`,children:(0,n.jsx)(t.code,{children:`DleDataService`})}),` (методы `,(0,n.jsx)(t.code,{children:`dataLoader()`}),` / `,(0,n.jsx)(t.code,{children:`dleData()`}),` удалены).`]}),`
`]}),`
