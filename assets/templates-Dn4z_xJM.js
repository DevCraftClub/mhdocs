import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Шаблоны`,description:`Структура Twig-шаблонов DevCraft Admin.`},i=new Date(1789411935e3),a=`
...
├── layout.twig           # Базовый макет Metro UI (+ module_css_urls / module_js_urls)
├── partials/
│   ├── header.twig
│   ├── sidebar.twig
│   ├── breadcrumb.twig
...
\`layout.twig\` в \`<head>\` подключает CSS из манифеста модуля (\`assets.css\` → \`module_css_urls\`), внизу страницы — JS (\`assets.js\` → \`module_js_urls\`).
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{children:`├── layout.twig           # Базовый макет Metro UI (+ module_css_urls / module_js_urls)`})}),`
...
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`layout.twig`}),` в `,(0,n.jsx)(t.code,{children:`<head>`}),` подключает CSS из манифеста модуля (`,(0,n.jsx)(t.code,{children:`assets.css`}),` → `,(0,n.jsx)(t.code,{children:`module_css_urls`}),`), внизу страницы — JS (`,(0,n.jsx)(t.code,{children:`assets.js`}),` → `,(0,n.jsx)(t.code,{children:`module_js_urls`}),`).`]}),`
