import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Установка`,description:`Особые шаги DLE API после общей установки плагина DevCraft.`,version:`200.1.0`},i=new Date(1789631874e3),a=`
...
Откройте модуль **DLE API** в DevCraft. Таблицы модуля создаёт **Cycle ORM** Admin (не DDL в \`install.xml\`):
...
Миграции пишутся в \`devcraft/src/database/migrations/\` при пересборке схемы ORM (см. [DatabaseGateway](../../devcraft_admin/200.4.0/reference/back-end/classes/DatabaseGateway#method_generateOrm) в Admin ≥ 200.4.0 с этим фиксом).

Если видите \`SQLSTATE[42S02]\` (таблица не найдена):

1. Убедитесь, что установлен актуальный DevCraft Admin с фиксом GenerateMigrations.
...
`,(0,n.jsxs)(t.p,{children:[`Откройте модуль `,(0,n.jsx)(t.strong,{children:`DLE API`}),` в DevCraft. Таблицы модуля создаёт `,(0,n.jsx)(t.strong,{children:`Cycle ORM`}),` Admin (не DDL в `,(0,n.jsx)(t.code,{children:`install.xml`}),`):`]}),`
`,(0,n.jsxs)(t.ul,{children:[`
...
`]}),`
`,(0,n.jsxs)(t.p,{children:[`Миграции пишутся в `,(0,n.jsx)(t.code,{children:`devcraft/src/database/migrations/`}),` при пересборке схемы ORM (см. `,(0,n.jsx)(t.a,{href:`../../devcraft_admin/200.4.0/reference/back-end/classes/DatabaseGateway#method_generateOrm`,children:`DatabaseGateway`}),` в Admin ≥ 200.4.0 с этим фиксом).`]}),`
`,(0,n.jsxs)(t.p,{children:[`Если видите `,(0,n.jsx)(t.code,{children:`SQLSTATE[42S02]`}),` (таблица не найдена):`]}),`
`,(0,n.jsxs)(t.ol,{children:[`
`,(0,n.jsx)(t.li,{children:`Убедитесь, что установлен актуальный DevCraft Admin с фиксом GenerateMigrations.`}),`
