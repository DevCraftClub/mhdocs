import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`English guide`,version:`1.0.0`},i=new Date(1786533408e3),a=`

## WebShare Proxy PHP Wrapper [#webshare-proxy-php-wrapper]

PHP client for the [WebShare Proxy API](https://apidocs.webshare.io): typed requests, filters, page iteration, GET response caching, and retries on \`429\` / \`5xx\`.
...
* \`App::Requests('Profile')->retrieve()\`
* \`App::Requests('IpAuthorization')->whatsMyIp()\`
* \`App::Requests('SubUser')->masqueradeAs(7)\`
* \`App::Requests('DownloadToken')->get('proxy_list')\`
`,o={contents:[{heading:`webshare-proxy-php-wrapper`,content:"PHP client for the WebShare Proxy API: typed requests, filters, page iteration, GET response caching, and retries on `429` / `5xx`."},{heading:`common-flows`,content:"`App::Requests('Profile')->retrieve()`"},{heading:`common-flows`,content:"`App::Requests('IpAuthorization')->whatsMyIp()`"},{heading:`common-flows`,content:"`App::Requests('SubUser')->masqueradeAs(7)`"},{heading:`common-flows`,content:"`App::Requests('DownloadToken')->get('proxy_list')`"}],headings:[{id:`webshare-proxy-php-wrapper`,content:`WebShare Proxy PHP Wrapper`},{id:`install`,content:`Install`},{id:`configure`,content:`Configure`},{id:`with-app`,content:"With `App`"},{id:`common-flows`,content:`Common flows`}]},s=[{depth:2,url:`#webshare-proxy-php-wrapper`,title:(0,n.jsx)(n.Fragment,{children:`WebShare Proxy PHP Wrapper`})},{depth:3,url:`#install`,title:(0,n.jsx)(n.Fragment,{children:`Install`})},{depth:3,url:`#configure`,title:(0,n.jsx)(n.Fragment,{children:`Configure`})},{depth:3,url:`#with-app`,title:(0,n.jsxs)(n.Fragment,{children:[`With `,(0,n.jsx)(`code`,{children:`App`})]})},{depth:3,url:`#common-flows`,title:(0,n.jsx)(n.Fragment,{children:`Common flows`})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,span:`span`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.h2,{id:`webshare-proxy-php-wrapper`,children:`WebShare Proxy PHP Wrapper`}),`
`,(0,n.jsxs)(t.p,{children:[`PHP client for the `,(0,n.jsx)(t.a,{href:`https://apidocs.webshare.io`,children:`WebShare Proxy API`}),`: typed requests, filters, page iteration, GET response caching, and retries on `,(0,n.jsx)(t.code,{children:`429`}),` / `,(0,n.jsx)(t.code,{children:`5xx`}),`.`]}),`
...
`,(0,n.jsx)(t.h3,{id:`configure`,children:`Configure`}),`
...
`,(0,n.jsxs)(t.h3,{id:`with-app`,children:[`With `,(0,n.jsx)(t.code,{children:`App`})]}),`
...
`,(0,n.jsx)(t.h3,{id:`common-flows`,children:`Common flows`}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.code,{children:`App::Requests('Profile')->retrieve()`})}),`
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.code,{children:`App::Requests('IpAuthorization')->whatsMyIp()`})}),`
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.code,{children:`App::Requests('SubUser')->masqueradeAs(7)`})}),`
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.code,{children:`App::Requests('DownloadToken')->get('proxy_list')`})}),`
