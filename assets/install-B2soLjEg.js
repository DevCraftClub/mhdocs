import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Installation`,description:`Install and configure DevCraft Dev Tools via Composer or a path repository.`,version:`1.0.1`},i=new Date(1786951824e3),a=`
...
<Tabs groupId="packageManager" items="['Composer', 'Source']">
  <Tab value="Composer">
    ...
    Composer also installs [\`marcin-orlowski/lombok-php\`](https://packagist.org/packages/marcin-orlowski/lombok-php) \`^1.2\`. \`AbstractWith\` extends \`\\Lombok\\Helper\`.
  </Tab>
  ...
  <Tab value="Source">
    ...
    Set \`url\` to the relative or absolute path of the package on disk. Later you can switch the path repository to a VCS/Packagist source and a version constraint.
  </Tab>
</Tabs>
...
Expected: version \`1.0.1\` and PHP \`>=8.3\`.
