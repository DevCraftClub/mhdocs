import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Класс: FormFieldBuilder`,description:`Документация по плагину класс: formfieldbuilder для DLE.`},i=new Date(1787142659e3),a=`
...
* public [editor()](#method_editor)
* public [codeViewer()](#method_codeViewer)
...
<span id="method_editor" />

### editor() [#editor]

Начинает описание WYSIWYG-поля (TinyMCE). Класс \`ajaxwysiwygeditor\` — селектор include \`tinymce_editor_scripts.twig\`. Второй класс: \`dc-{toTranslit($id)}-editor\`. Не передавать \`class\` в последующем \`metro()\` — ключ перезапишется целиком.

На странице нужен include:

\`\`\`twig
{% if pm_wysiwyg and pm_editor_script %}
    {% include 'core/includes/ui/templateIncludes/tinymce_editor_scripts.twig' %}
{% endif %}
\`\`\`
...
**Возвращает:** \`self\` — Новый строитель textarea-поля с TinyMCE.

<span id="method_codeViewer" />

### codeViewer() [#codeviewer]

Начинает описание поля исходника HTML (ACE, не WYSIWYG). Класс \`html_editor\` — селектор include \`code_editor_scripts.twig\`. ACE нельзя вызывать повторно на уже инициализированный textarea: include пропускает поля с соседним \`.code_editor_area\` и делает \`resize()\`.

На странице нужен include:

\`\`\`twig
{% include 'core/includes/ui/templateIncludes/code_editor_scripts.twig' %}
\`\`\`
...
**Возвращает:** \`self\` — Новый строитель textarea-поля с ACE.
...
`,(0,n.jsxs)(t.li,{children:[`public `,(0,n.jsx)(t.a,{href:`#method_editor`,children:`editor()`})]}),`
`,(0,n.jsxs)(t.li,{children:[`public `,(0,n.jsx)(t.a,{href:`#method_codeViewer`,children:`codeViewer()`})]}),`
...
`,(0,n.jsx)(`span`,{id:`method_editor`}),`
`,(0,n.jsx)(t.h3,{id:`editor`,children:`editor()`}),`
`,(0,n.jsxs)(t.p,{children:[`Начинает описание WYSIWYG-поля (TinyMCE). Класс `,(0,n.jsx)(t.code,{children:`ajaxwysiwygeditor`}),` — селектор include `,(0,n.jsx)(t.code,{children:`tinymce_editor_scripts.twig`}),`. Второй класс: `,(0,n.jsx)(t.code,{children:`dc-{toTranslit($id)}-editor`}),`. Не передавать `,(0,n.jsx)(t.code,{children:`class`}),` в последующем `,(0,n.jsx)(t.code,{children:`metro()`}),` — ключ перезапишется целиком.`]}),`
`,(0,n.jsx)(t.p,{children:`На странице нужен include:`}),`
`,(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(t.pre,{className:`shiki shiki-themes github-light github-dark`,style:{"--shiki-light":`#24292e`,"--shiki-dark":`#e1e4e8`,"--shiki-light-bg":`#fff`,"--shiki-dark-bg":`#24292e`},tabIndex:`0`,icon:`<svg viewBox="0 0 24 24"><path d="M 6,1 C 4.354992,1 3,2.354992 3,4 v 16 c 0,1.645008 1.354992,3 3,3 h 12 c 1.645008,0 3,-1.354992 3,-3 V 8 7 A 1.0001,1.0001 0 0 0 20.707031,6.2929687 l -5,-5 A 1.0001,1.0001 0 0 0 15,1 h -1 z m 0,2 h 7 v 3 c 0,1.645008 1.354992,3 3,3 h 3 v 11 c 0,0.564129 -0.435871,1 -1,1 H 6 C 5.4358712,21 5,20.564129 5,20 V 4 C 5,3.4358712 5.4358712,3 6,3 Z M 15,3.4140625 18.585937,7 H 16 C 15.435871,7 15,6.5641288 15,6 Z" fill="currentColor" /></svg>`,children:(0,n.jsxs)(t.code,{children:[(0,n.jsxs)(t.span,{className:`line`,children:[(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`{% `}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:`if`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:` pm_wysiwyg `}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:`and`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:` pm_editor_script %}`})]}),`
`,(0,n.jsxs)(t.span,{className:`line`,children:[(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`    {% `}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:`include`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#032F62`,"--shiki-dark":`#9ECBFF`},children:` 'core/includes/ui/templateIncludes/tinymce_editor_scripts.twig'`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:` %}`})]}),`
`,(0,n.jsxs)(t.span,{className:`line`,children:[(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`{% `}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:`endif`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:` %}`})]})]})})}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`С версии:`}),` 200.4.0`]}),`
`,(0,n.jsx)(t.p,{children:(0,n.jsx)(t.strong,{children:`Параметры:`})}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$id`}),` — Идентификатор поля.`]}),`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$label`}),` — Подпись.`]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`self`}),` — Новый строитель textarea-поля с TinyMCE.`]}),`
`,(0,n.jsx)(`span`,{id:`method_codeViewer`}),`
`,(0,n.jsx)(t.h3,{id:`codeviewer`,children:`codeViewer()`}),`
`,(0,n.jsxs)(t.p,{children:[`Начинает описание поля исходника HTML (ACE, не WYSIWYG). Класс `,(0,n.jsx)(t.code,{children:`html_editor`}),` — селектор include `,(0,n.jsx)(t.code,{children:`code_editor_scripts.twig`}),`. ACE нельзя вызывать повторно на уже инициализированный textarea: include пропускает поля с соседним `,(0,n.jsx)(t.code,{children:`.code_editor_area`}),` и делает `,(0,n.jsx)(t.code,{children:`resize()`}),`.`]}),`
`,(0,n.jsx)(t.p,{children:`На странице нужен include:`}),`
`,(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(t.pre,{className:`shiki shiki-themes github-light github-dark`,style:{"--shiki-light":`#24292e`,"--shiki-dark":`#e1e4e8`,"--shiki-light-bg":`#fff`,"--shiki-dark-bg":`#24292e`},tabIndex:`0`,icon:`<svg viewBox="0 0 24 24"><path d="M 6,1 C 4.354992,1 3,2.354992 3,4 v 16 c 0,1.645008 1.354992,3 3,3 h 12 c 1.645008,0 3,-1.354992 3,-3 V 8 7 A 1.0001,1.0001 0 0 0 20.707031,6.2929687 l -5,-5 A 1.0001,1.0001 0 0 0 15,1 h -1 z m 0,2 h 7 v 3 c 0,1.645008 1.354992,3 3,3 h 3 v 11 c 0,0.564129 -0.435871,1 -1,1 H 6 C 5.4358712,21 5,20.564129 5,20 V 4 C 5,3.4358712 5.4358712,3 6,3 Z M 15,3.4140625 18.585937,7 H 16 C 15.435871,7 15,6.5641288 15,6 Z" fill="currentColor" /></svg>`,children:(0,n.jsx)(t.code,{children:(0,n.jsxs)(t.span,{className:`line`,children:[(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`{% `}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#D73A49`,"--shiki-dark":`#F97583`},children:`include`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#032F62`,"--shiki-dark":`#9ECBFF`},children:` 'core/includes/ui/templateIncludes/code_editor_scripts.twig'`}),(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:` %}`})]})})})}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`С версии:`}),` 200.4.0`]}),`
`,(0,n.jsx)(t.p,{children:(0,n.jsx)(t.strong,{children:`Параметры:`})}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$id`}),` — Идентификатор поля.`]}),`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$label`}),` — Подпись.`]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`self`}),` — Новый строитель textarea-поля с ACE.`]}),`
