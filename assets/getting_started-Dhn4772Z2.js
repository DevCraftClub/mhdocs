import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Getting started`,description:`Overview of DevCraft Dev Tools, architecture, requirements, and first steps.`,version:`1.0.1`},i=new Date(1786951824e3),a=`
...
<Cards>
  ...
  <Card title="Guides" href="/dev/dev-tools/1.0.1/en/guides/with_attributes">
    Step-by-step usage
  </Card>
...
* PHP 8.3 or newer
* Composer
* Transitive runtime: \`marcin-orlowski/lombok-php\` \`^1.2\`
...
`,o={contents:[{heading:void 0,content:"Package `devcraftclub/dev-tools` is a PHP 8.3 library with two complementary capabilities:"},{heading:void 0,content:"**Fluent mutation and accessors** — `#[With]` / `#[WithItem]`, `#[Getter]` / `#[Setter]` (lombok-php), `AbstractWith`."},{heading:void 0,content:"**DTO mapping** — `AbstractReflection`, array hydration, attribute validation, `toArray()` / `toJson()`."},{heading:void 0,content:`These base classes use different property models and are **not** meant to be combined through inheritance.`},{heading:`documentation-sections`,content:`Packagist and path repository`},{heading:`documentation-sections`,content:`Step-by-step usage`},{heading:`documentation-sections`,content:`Classes, methods, and types`},{heading:`documentation-sections`,content:`Release history`},{heading:`quick-start`,content:`DTO mapping:`},{heading:`requirements`,content:`PHP 8.3 or newer`},{heading:`requirements`,content:`Composer`},{heading:`requirements`,content:"Transitive runtime: `marcin-orlowski/lombok-php` `^1.2`"},{heading:`next-steps`,content:`Installation`},{heading:`next-steps`,content:`With attributes`},{heading:`next-steps`,content:`API reference`}],headings:[{id:`architecture`,content:`Architecture`},{id:`documentation-sections`,content:`Documentation sections`},{id:`quick-start`,content:`Quick start`},{id:`requirements`,content:`Requirements`},{id:`next-steps`,content:`Next steps`}]},s=[{depth:2,url:`#architecture`,title:(0,n.jsx)(n.Fragment,{children:`Architecture`})},{depth:2,url:`#documentation-sections`,title:(0,n.jsx)(n.Fragment,{children:`Documentation sections`})},{depth:2,url:`#quick-start`,title:(0,n.jsx)(n.Fragment,{children:`Quick start`})},{depth:2,url:`#requirements`,title:(0,n.jsx)(n.Fragment,{children:`Requirements`})},{depth:2,url:`#next-steps`,title:(0,n.jsx)(n.Fragment,{children:`Next steps`})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...e.components},{Card:r,Cards:i}=t;return r||u(`Card`,!0),i||u(`Cards`,!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[`Package `,(0,n.jsx)(t.code,{children:`devcraftclub/dev-tools`}),` is a PHP 8.3 library with two complementary capabilities:`]}),`
...
`,(0,n.jsxs)(i,{children:[(0,n.jsx)(r,{title:`Installation`,href:`/dev/dev-tools/1.0.1/en/install`,children:(0,n.jsx)(t.p,{children:`Packagist and path repository`})}),(0,n.jsx)(r,{title:`Guides`,href:`/dev/dev-tools/1.0.1/en/guides/with_attributes`,children:(0,n.jsx)(t.p,{children:`Step-by-step usage`})}),(0,n.jsx)(r,{title:`API reference`,href:`/dev/dev-tools/1.0.1/reference`,children:(0,n.jsx)(t.p,{children:`Classes, methods, and types`})}),(0,n.jsx)(r,{title:`Changelog`,href:`/dev/dev-tools/1.0.1/en/changelog`,children:(0,n.jsx)(t.p,{children:`Release history`})})]}),`
...
`,(0,n.jsx)(t.li,{children:`Composer`}),`
`,(0,n.jsxs)(t.li,{children:[`Transitive runtime: `,(0,n.jsx)(t.code,{children:`marcin-orlowski/lombok-php`}),` `,(0,n.jsx)(t.code,{children:`^1.2`})]}),`
`]}),`
