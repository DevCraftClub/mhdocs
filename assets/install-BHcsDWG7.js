import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Установка`,description:`Как поставить TagsAdd после DevCraft Admin: ZIP, Composer, первый запуск.`,version:`200.3.1`},i=new Date(1789411081e3),a=`
...
3. Убедитесь, что на сайте есть:
   ...
   * \`templates/Default/devcraft/tags_add/\` (при другой теме — скопируйте каталог в свой скин)
...
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`templates/Default/devcraft/tags_add/`}),` (при другой теме — скопируйте каталог в свой скин)`]}),`
`]}),`
`]}),`
`]}),`
