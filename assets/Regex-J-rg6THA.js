import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Regex`,description:`ValidationRule: совпадение строки с регулярным выражением.`,version:`1.0.0`},i=new Date(1787834766e3),a=`
...
**Исключения:** \`InvalidArgumentException\`, если паттерн невалиден (\`preg_match\` вернул \`false\`).
...
public string $id;
\`\`\`
`,o={contents:[{heading:void 0,content:"**Описание:** Атрибут валидации строки по PCRE-паттерну. Реализует `ValidationRule`. Repeatable."},{heading:void 0,content:"**Namespace:** `Devcraft\\Attributes`"},{heading:void 0,content:"**Target:** `Attribute::TARGET_PROPERTY | Attribute::IS_REPEATABLE`"},{heading:void 0,content:`**Implements:** ValidationRule`},{heading:void 0,content:`**С версии:** 1.0.0`},{heading:void 0,content:`**См. также:**`},{heading:void 0,content:`Гайд: валидация`},{heading:`__constructstring-pattern`,content:`**Параметры:**`},{heading:`__constructstring-pattern`,content:"`$pattern` (string): PCRE-выражение"},{heading:`__constructstring-pattern`,content:"**Исключения:** `InvalidArgumentException`, если паттерн невалиден (`preg_match` вернул `false`)."},{heading:`validatemixed-value-string`,content:"**Описание:** `null` проходит. Не string → `must be a string`. Нет совпадения → `must match {pattern}`."}],headings:[{id:`__constructstring-pattern`,content:"`__construct(string $pattern)`"},{id:`validatemixed-value-string`,content:"`validate(mixed $value): ?string`"}]},s=[{depth:2,url:`#__constructstring-pattern`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`__construct(string $pattern)`})})},{depth:2,url:`#validatemixed-value-string`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`validate(mixed $value): ?string`})})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Описание:`}),` Атрибут валидации строки по PCRE-паттерну. Реализует `,(0,n.jsx)(t.code,{children:`ValidationRule`}),`. Repeatable.`]}),`
...
`]}),`
`,(0,n.jsx)(t.h2,{id:`__constructstring-pattern`,children:(0,n.jsx)(t.code,{children:`__construct(string $pattern)`})}),`
`,(0,n.jsx)(t.p,{children:(0,n.jsx)(t.strong,{children:`Параметры:`})}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$pattern`}),` (string): PCRE-выражение`]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Исключения:`}),` `,(0,n.jsx)(t.code,{children:`InvalidArgumentException`}),`, если паттерн невалиден (`,(0,n.jsx)(t.code,{children:`preg_match`}),` вернул `,(0,n.jsx)(t.code,{children:`false`}),`).`]}),`
