import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Миграция`,description:`Перенос DB Manager с MHAdmin на DevCraft Admin 200.1.4.`},i=new Date(1789560091e3),a=`

Версия **200.1.4** работает только с [DevCraft Admin](../../devcraft_admin/install&#x29; **≥ 200.4.0**. Автоматический перенос настроек **не выполняется**.
...
| Legacy (MHAdmin)                                         | DevCraft (200.1.4)                           |
| -------------------------------------------------------- | -------------------------------------------- |
...
### 3. Установка DB Manager 200.1.4 [#3-установка-db-manager-20014]
...
`,(0,n.jsx)(t.h3,{id:`3-установка-db-manager-20014`,children:`3. Установка DB Manager 200.1.4`}),`
