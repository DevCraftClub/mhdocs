import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Начало работы`,description:`Установка DevCraft Dev Tools, выбор базового класса, fluent builder и DTO.`,version:`1.0.0`},i=new Date(1787750944e3),a=`
...
<Cards>
  <Card title="Установка" href="/dev/dev-tools/1.0.0/install">
    Packagist и path repository
  </Card>

  <Card title="Атрибуты With" href="/dev/dev-tools/1.0.0/guides/with_attributes">
    Fluent-билдеры и WithHandler
  </Card>

  <Card title="Reflection mapper" href="/dev/dev-tools/1.0.0/guides/reflection_mapper">
    Гидратация и сериализация DTO
  </Card>

  <Card title="Валидация" href="/dev/dev-tools/1.0.0/guides/validation">
    Filter, Range, Regex, ArrayOf
  </Card>

  <Card title="Справочник" href="/dev/dev-tools/1.0.0/reference">
    Все классы и атрибуты пакета
  </Card>

  <Card title="English" href="/dev/dev-tools/1.0.0/en/getting_started">
...
| ------------------------------- | -------------------- | ------------------------------------------------- |
| Fluent builders / query objects | \`AbstractWith\`       | Private (или protected), non-static, non-readonly |
...
`,o={contents:[{heading:void 0,content:"Пакет `devcraftclub/dev-tools` — библиотека PHP 8.3 с двумя взаимодополняющими возможностями:"},{heading:void 0,content:"**Fluent mutation** — `#[With]` / `#[WithItem]`, `AbstractWith`, runtime-методы `with*`."},{heading:void 0,content:"**DTO mapping** — `AbstractReflection`, гидратация из массива, валидация атрибутами, `toArray()` / `toJson()`."},{heading:void 0,content:`Эти базовые классы рассчитаны на разные модели свойств и **не** предназначены для объединения через наследование.`},{heading:`разделы-документации`,content:`Packagist и path repository`},{heading:`разделы-документации`,content:`Fluent-билдеры и WithHandler`},{heading:`разделы-документации`,content:`Гидратация и сериализация DTO`},{heading:`разделы-документации`,content:`Filter, Range, Regex, ArrayOf`},{heading:`разделы-документации`,content:`Все классы и атрибуты пакета`},{heading:`разделы-документации`,content:`Full English documentation`},{heading:`выбор-базового-класса`,content:`Нужно`},{heading:`выбор-базового-класса`,content:`Наследовать`},{heading:`выбор-базового-класса`,content:`Стиль свойств`},{heading:`выбор-базового-класса`,content:`Fluent builders / query objects`},{heading:`выбор-базового-класса`,content:"`AbstractWith`"},{heading:`выбор-базового-класса`,content:`Private (или protected), non-static, non-readonly`},{heading:`выбор-базового-класса`,content:`API response / request DTO`},{heading:`выбор-базового-класса`,content:"`AbstractReflection`"},{heading:`выбор-базового-класса`,content:`Public, typed, hydratable`},{heading:`выбор-базового-класса`,content:`Не комбинируйте их через inheritance. Если нужны оба формы — composition или два отдельных класса.`}],headings:[{id:`архитектура`,content:`Архитектура`},{id:`разделы-документации`,content:`Разделы документации`},{id:`быстрый-пример-abstractwith`,content:"Быстрый пример `AbstractWith`"},{id:`быстрый-пример-abstractreflection`,content:"Быстрый пример `AbstractReflection`"},{id:`выбор-базового-класса`,content:`Выбор базового класса`}]},s=[{depth:2,url:`#архитектура`,title:(0,n.jsx)(n.Fragment,{children:`Архитектура`})},{depth:2,url:`#разделы-документации`,title:(0,n.jsx)(n.Fragment,{children:`Разделы документации`})},{depth:2,url:`#быстрый-пример-abstractwith`,title:(0,n.jsxs)(n.Fragment,{children:[`Быстрый пример `,(0,n.jsx)(`code`,{children:`AbstractWith`})]})},{depth:2,url:`#быстрый-пример-abstractreflection`,title:(0,n.jsxs)(n.Fragment,{children:[`Быстрый пример `,(0,n.jsx)(`code`,{children:`AbstractReflection`})]})},{depth:2,url:`#выбор-базового-класса`,title:(0,n.jsx)(n.Fragment,{children:`Выбор базового класса`})}];function c(e){let t={code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,...e.components},{Card:r,Cards:i}=t;return r||u(`Card`,!0),i||u(`Cards`,!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[`Пакет `,(0,n.jsx)(t.code,{children:`devcraftclub/dev-tools`}),` — библиотека PHP 8.3 с двумя взаимодополняющими возможностями:`]}),`
...
`,(0,n.jsxs)(i,{children:[(0,n.jsx)(r,{title:`Установка`,href:`/dev/dev-tools/1.0.0/install`,children:(0,n.jsx)(t.p,{children:`Packagist и path repository`})}),(0,n.jsx)(r,{title:`Атрибуты With`,href:`/dev/dev-tools/1.0.0/guides/with_attributes`,children:(0,n.jsx)(t.p,{children:`Fluent-билдеры и WithHandler`})}),(0,n.jsx)(r,{title:`Reflection mapper`,href:`/dev/dev-tools/1.0.0/guides/reflection_mapper`,children:(0,n.jsx)(t.p,{children:`Гидратация и сериализация DTO`})}),(0,n.jsx)(r,{title:`Валидация`,href:`/dev/dev-tools/1.0.0/guides/validation`,children:(0,n.jsx)(t.p,{children:`Filter, Range, Regex, ArrayOf`})}),(0,n.jsx)(r,{title:`Справочник`,href:`/dev/dev-tools/1.0.0/reference`,children:(0,n.jsx)(t.p,{children:`Все классы и атрибуты пакета`})}),(0,n.jsx)(r,{title:`English`,href:`/dev/dev-tools/1.0.0/en/getting_started`,children:(0,n.jsx)(t.p,{children:`Full English documentation`})})]}),`
...
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Нужно`}),(0,n.jsx)(t.th,{children:`Наследовать`}),(0,n.jsx)(t.th,{children:`Стиль свойств`})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`Fluent builders / query objects`}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`AbstractWith`})}),(0,n.jsx)(t.td,{children:`Private (или protected), non-static, non-readonly`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`API response / request DTO`}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`AbstractReflection`})}),(0,n.jsx)(t.td,{children:`Public, typed, hydratable`})]})]})]}),`
`,(0,n.jsx)(t.p,{children:`Не комбинируйте их через inheritance. Если нужны оба формы — composition или два отдельных класса.`})]})}function l(e={}){let{wrapper:t}=e.components||{};return t?(0,n.jsx)(t,{...e,children:(0,n.jsx)(c,{...e})}):c(e)}function u(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{a as _markdown,l as default,r as frontmatter,i as lastModified,o as structuredData,s as toc};