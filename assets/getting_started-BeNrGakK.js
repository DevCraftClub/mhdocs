import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Начало работы`,description:`Обзор модуля DLE Уведомления: каналы, подписки, требования и первые шаги`,version:`200.1.0`},i=new Date(1787750944e3),a=`
...
\`\`\`
{include file="engine/modules/devcraft/notifications_site.php?focus=css"}
\`\`\`

Полная новость (\`fullstory.tpl\`):

\`\`\`
{include file="engine/modules/devcraft/notifications_site.php?focus=subscribe&stype=news&id={news-id}"}
\`\`\`
    ...
    <Folder name="engine">
      ...
      <Folder name="modules">
        <Folder name="devcraft">
          ...
          <File name="notifications_site.php" />

          <File name="notifications_page.php" />
        </Folder>
      </Folder>
    </Folder>
...
* \`notifications_site.php\` — подключение на сайте через \`{include}\` (\`focus=css|js|badge|wall|subscribe\`).
* \`notifications_page.php\` + \`notifications.tpl\` — страница \`do=notifications\`.
...
Тип (\`news\`, \`cat\`, \`user\`, \`tag\`, \`xfield\`, \`all\`) задаёт, на что подписан пользователь. Кнопка на странице — \`focus=subscribe\` с \`type\` и \`id\`. Подробнее: [типы подписок](./guides/subscription_types).
...
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`notifications_site.php`}),` — подключение на сайте через `,(0,n.jsx)(t.code,{children:`{include}`}),` (`,(0,n.jsx)(t.code,{children:`focus=css|js|badge|wall|subscribe`}),`).`]}),`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`notifications_page.php`}),` + `,(0,n.jsx)(t.code,{children:`notifications.tpl`}),` — страница `,(0,n.jsx)(t.code,{children:`do=notifications`}),`.`]}),`
