import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Валидация`,description:`Filter, Range, Regex, ArrayOf, PropertyValidator и ValidationException.`,version:`1.1.0`},i=new Date(1789411935e3),a=`
...
* [Установка](../install)
* [Маппер по reflection](reflection_mapper)

## Контракт правила [#контракт-правила]
...
Для \`FILTER_VALIDATE_BOOLEAN\` автоматически добавляется \`FILTER_NULL_ON_FAILURE\`, чтобы неверные значения отклонялись, а не превращались в \`false\`.
...
Конструктор проверяет шаблон через \`preg_match\` и бросает \`InvalidArgumentException\`, если выражение битое. Не-строка → \`must be a string\`.
...
Встроенные имена: \`mixed\`, \`string\`, \`int\`/\`integer\`, \`float\`/\`double\`, \`bool\`/\`boolean\`, \`array\`, \`object\`. Остальные — проверка class/interface через \`instanceof\`.
...
\`validateObject()\` смотрит только public, не static, уже инициализированные свойства. Атрибуты не из \`ValidationRule\` игнорируются. Несколько правил на одном свойстве дают несколько сообщений.
...
* [ValidationRule](../reference/interfaces/ValidationRule)
* [PropertyValidator](../reference/validation/PropertyValidator)
* [ValidationException](../reference/exceptions/ValidationException)
* [Справочник API](../reference)
* [История изменений](../changelog)
`,o={contents:[{heading:`введение`,content:"Правила проверки — PHP-атрибуты, реализующие `Devcraft\\Interfaces\\ValidationRule`. Метод `validate()` возвращает `null`, если значение подходит, иначе короткое сообщение **без** самого значения. Вход `null` всегда проходит: обязательность поля решает запасной путь mapper при заполнении из массива."},{heading:`введение`,content:"Зачем: одни и те же правила на DTO (`AbstractReflection`) и при ручной проверке через `PropertyValidator`."},{heading:`предварительные-требования`,content:`Начало работы`},{heading:`предварительные-требования`,content:`Установка`},{heading:`предварительные-требования`,content:`Маппер по reflection`},{heading:`контракт-правила`,content:"Сообщения описывают ожидание (`must be numeric`), не фактическое значение. Пути полей и типы добавляют `ReflectionMapper` / `ValidationException`."},{heading:`контракт-правила`,content:`См. также: ValidationRule, PropertyValidator, ValidationException.`},{heading:`атрибуты`,content:`Все атрибуты валидации вешаются на свойства и могут повторяться.`},{heading:`filter`,content:"Обёртка над PHP `filter_var`:"},{heading:`filter`,content:"Для `FILTER_VALIDATE_BOOLEAN` автоматически добавляется `FILTER_NULL_ON_FAILURE`, чтобы неверные значения отклонялись, а не превращались в `false`."},{heading:`filter`,content:"Сообщение при ошибке: `must pass filter <id>`."},{heading:`filter`,content:`См. Filter.`},{heading:`range`,content:"Числовые границы для `int` или `float`:"},{heading:`range`,content:"Любую границу можно опустить. Нечисловые значения → `must be numeric`."},{heading:`range`,content:`См. Range.`},{heading:`regex`,content:`Совпадение строки с шаблоном:`},{heading:`regex`,content:"Конструктор проверяет шаблон через `preg_match` и бросает `InvalidArgumentException`, если выражение битое. Не-строка → `must be a string`."},{heading:`regex`,content:`См. Regex.`},{heading:`arrayof`,content:`Значение — список, элементы которого соответствуют имени типа:`},{heading:`arrayof`,content:"Встроенные имена: `mixed`, `string`, `int`/`integer`, `float`/`double`, `bool`/`boolean`, `array`, `object`. Остальные — проверка class/interface через `instanceof`."},{heading:`arrayof`,content:"В `ReflectionMapper` `ArrayOf` ещё и управляет преобразованием элементов **до** валидации."},{heading:`arrayof`,content:`См. ArrayOf.`},{heading:`propertyvalidator`,content:"`Devcraft\\Validation\\PropertyValidator` запускает правила атрибутов **без** заполнения из массива:"},{heading:`propertyvalidator`,content:"`validateObject()` смотрит только public, не static, уже инициализированные свойства. Атрибуты не из `ValidationRule` игнорируются. Несколько правил на одном свойстве дают несколько сообщений."},{heading:`validationexception`,content:"Бросается `ReflectionMapper`, когда один или несколько обязательных путей не проходят:"},{heading:`validationexception`,content:"`getErrors()` возвращает `array<string, list<string>>`: ключ — путь свойства через точку."},{heading:`связанные-разделы`,content:`ValidationRule`},{heading:`связанные-разделы`,content:`PropertyValidator`},{heading:`связанные-разделы`,content:`ValidationException`},{heading:`связанные-разделы`,content:`Справочник API`},{heading:`связанные-разделы`,content:`История изменений`}],headings:[{id:`введение`,content:`Введение`},{id:`предварительные-требования`,content:`Предварительные требования`},{id:`контракт-правила`,content:`Контракт правила`},{id:`атрибуты`,content:`Атрибуты`},{id:`filter`,content:"`Filter`"},{id:`range`,content:"`Range`"},{id:`regex`,content:"`Regex`"},{id:`arrayof`,content:"`ArrayOf`"},{id:`propertyvalidator`,content:`PropertyValidator`},{id:`validationexception`,content:`ValidationException`},{id:`связанные-разделы`,content:`Связанные разделы`}]},s=[{depth:2,url:`#введение`,title:(0,n.jsx)(n.Fragment,{children:`Введение`})},{depth:2,url:`#предварительные-требования`,title:(0,n.jsx)(n.Fragment,{children:`Предварительные требования`})},{depth:2,url:`#контракт-правила`,title:(0,n.jsx)(n.Fragment,{children:`Контракт правила`})},{depth:2,url:`#атрибуты`,title:(0,n.jsx)(n.Fragment,{children:`Атрибуты`})},{depth:3,url:`#filter`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`Filter`})})},{depth:3,url:`#range`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`Range`})})},{depth:3,url:`#regex`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`Regex`})})},{depth:3,url:`#arrayof`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`ArrayOf`})})},{depth:2,url:`#propertyvalidator`,title:(0,n.jsx)(n.Fragment,{children:`PropertyValidator`})},{depth:2,url:`#validationexception`,title:(0,n.jsx)(n.Fragment,{children:`ValidationException`})},{depth:2,url:`#связанные-разделы`,title:(0,n.jsx)(n.Fragment,{children:`Связанные разделы`})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.h2,{id:`введение`,children:`Введение`}),`
`,(0,n.jsxs)(t.p,{children:[`Правила проверки — PHP-атрибуты, реализующие `,(0,n.jsx)(t.code,{children:`Devcraft\\Interfaces\\ValidationRule`}),`. Метод `,(0,n.jsx)(t.code,{children:`validate()`}),` возвращает `,(0,n.jsx)(t.code,{children:`null`}),`, если значение подходит, иначе короткое сообщение `,(0,n.jsx)(t.strong,{children:`без`}),` самого значения. Вход `,(0,n.jsx)(t.code,{children:`null`}),` всегда проходит: обязательность поля решает запасной путь mapper при заполнении из массива.`]}),`
`,(0,n.jsxs)(t.p,{children:[`Зачем: одни и те же правила на DTO (`,(0,n.jsx)(t.code,{children:`AbstractReflection`}),`) и при ручной проверке через `,(0,n.jsx)(t.code,{children:`PropertyValidator`}),`.`]}),`
...
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.a,{href:`reflection_mapper`,children:`Маппер по reflection`})}),`
`]}),`
`,(0,n.jsx)(t.h2,{id:`контракт-правила`,children:`Контракт правила`}),`
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{style:{"--shiki-light":`#6A737D`,"--shiki-dark":`#6A737D`},children:`    /** null — ок; иначе сообщение без фактического значения. */`})}),`
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`}`})})]})})}),`
`,(0,n.jsxs)(t.p,{children:[`Сообщения описывают ожидание (`,(0,n.jsx)(t.code,{children:`must be numeric`}),`), не фактическое значение. Пути полей и типы добавляют `,(0,n.jsx)(t.code,{children:`ReflectionMapper`}),` / `,(0,n.jsx)(t.code,{children:`ValidationException`}),`.`]}),`
...
`,(0,n.jsx)(t.p,{children:`Все атрибуты валидации вешаются на свойства и могут повторяться.`}),`
...
`,(0,n.jsxs)(t.p,{children:[`Для `,(0,n.jsx)(t.code,{children:`FILTER_VALIDATE_BOOLEAN`}),` автоматически добавляется `,(0,n.jsx)(t.code,{children:`FILTER_NULL_ON_FAILURE`}),`, чтобы неверные значения отклонялись, а не превращались в `,(0,n.jsx)(t.code,{children:`false`}),`.`]}),`
...
`,(0,n.jsx)(t.p,{children:`Совпадение строки с шаблоном:`}),`
...
`,(0,n.jsxs)(t.p,{children:[`Конструктор проверяет шаблон через `,(0,n.jsx)(t.code,{children:`preg_match`}),` и бросает `,(0,n.jsx)(t.code,{children:`InvalidArgumentException`}),`, если выражение битое. Не-строка → `,(0,n.jsx)(t.code,{children:`must be a string`}),`.`]}),`
...
`,(0,n.jsx)(t.p,{children:`Значение — список, элементы которого соответствуют имени типа:`}),`
...
`,(0,n.jsxs)(t.p,{children:[`Встроенные имена: `,(0,n.jsx)(t.code,{children:`mixed`}),`, `,(0,n.jsx)(t.code,{children:`string`}),`, `,(0,n.jsx)(t.code,{children:`int`}),`/`,(0,n.jsx)(t.code,{children:`integer`}),`, `,(0,n.jsx)(t.code,{children:`float`}),`/`,(0,n.jsx)(t.code,{children:`double`}),`, `,(0,n.jsx)(t.code,{children:`bool`}),`/`,(0,n.jsx)(t.code,{children:`boolean`}),`, `,(0,n.jsx)(t.code,{children:`array`}),`, `,(0,n.jsx)(t.code,{children:`object`}),`. Остальные — проверка class/interface через `,(0,n.jsx)(t.code,{children:`instanceof`}),`.`]}),`
`,(0,n.jsxs)(t.p,{children:[`В `,(0,n.jsx)(t.code,{children:`ReflectionMapper`}),` `,(0,n.jsx)(t.code,{children:`ArrayOf`}),` ещё и управляет преобразованием элементов `,(0,n.jsx)(t.strong,{children:`до`}),` валидации.`]}),`
...
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`Devcraft\\Validation\\PropertyValidator`}),` запускает правила атрибутов `,(0,n.jsx)(t.strong,{children:`без`}),` заполнения из массива:`]}),`
...
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`validateObject()`}),` смотрит только public, не static, уже инициализированные свойства. Атрибуты не из `,(0,n.jsx)(t.code,{children:`ValidationRule`}),` игнорируются. Несколько правил на одном свойстве дают несколько сообщений.`]}),`
`,(0,n.jsx)(t.h2,{id:`validationexception`,children:`ValidationException`}),`
`,(0,n.jsxs)(t.p,{children:[`Бросается `,(0,n.jsx)(t.code,{children:`ReflectionMapper`}),`, когда один или несколько обязательных путей не проходят:`]}),`
...
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{style:{"--shiki-light":`#6A737D`,"--shiki-dark":`#6A737D`},children:`    // ]`})}),`
`,(0,n.jsx)(t.span,{className:`line`,children:(0,n.jsx)(t.span,{style:{"--shiki-light":`#24292E`,"--shiki-dark":`#E1E4E8`},children:`}`})})]})})}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.code,{children:`getErrors()`}),` возвращает `,(0,n.jsx)(t.code,{children:`array<string, list<string>>`}),`: ключ — путь свойства через точку.`]}),`
`,(0,n.jsx)(t.h2,{id:`связанные-разделы`,children:`Связанные разделы`}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.a,{href:`../reference/interfaces/ValidationRule`,children:`ValidationRule`})}),`
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.a,{href:`../reference/validation/PropertyValidator`,children:`PropertyValidator`})}),`
`,(0,n.jsx)(t.li,{children:(0,n.jsx)(t.a,{href:`../reference/exceptions/ValidationException`,children:`ValidationException`})}),`
