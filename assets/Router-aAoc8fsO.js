import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Класс: Router`,description:`Документация по плагину класс: router для DLE.`},i=new Date(1789555699e3),a=`
...
* private [buildModuleCssUrls()](#method_buildModuleCssUrls)
* private [buildModuleAssetUrls()](#method_buildModuleAssetUrls)
...
<span id="method_buildModuleCssUrls" />

### buildModuleCssUrls() [#buildmodulecssurls]
...
**Возвращает:** \`list<string>\` — URL стилей модуля (\`module_css_urls\` в layout).

<span id="method_buildModuleAssetUrls" />

### buildModuleAssetUrls() [#buildmoduleasseturls]

Общий сборщик URL файлов из \`Public/\` модуля.
...
* \`$plugin\` — Контекст модуля.
* \`$files\` — Имена файлов относительно Public/.

**Возвращает:** \`list<string>\` — URL с \`?v=\` по mtime.
...
`,o={contents:[{heading:`краткое-содержание`,content:`Маршрутизатор административных запросов DevCraft.`},{heading:`свойства`,content:`*Нет публичных свойств.*`},{heading:`методы`,content:`public dispatch()`},{heading:`методы`,content:`private buildModuleJsUrls()`},{heading:`методы`,content:`private buildModuleCssUrls()`},{heading:`методы`,content:`private buildModuleAssetUrls()`},{heading:`методы`,content:`private buildTranslationJsUrl()`},{heading:`методы`,content:`private buildMetroI18nUrl()`},{heading:`методы`,content:`private layoutWrap()`},{heading:`подробности`,content:"Путь: `devcraft/src/classes/Admin/Router.php`"},{heading:`dispatch`,content:`Обрабатывает запрос админки: инициализирует контекст, вызывает страницу и рендерит layout.`},{heading:`dispatch`,content:`**С версии:** 200.4.0`},{heading:`dispatch`,content:`**Параметры:**`},{heading:`dispatch`,content:"`$plugin` — Контекст модуля."},{heading:`dispatch`,content:"`$action` — Имя действия или пустая строка для значения по умолчанию."},{heading:`buildmodulejsurls`,content:`Собирает URL публичных JS-файлов модуля с версией по mtime.`},{heading:`buildmodulejsurls`,content:`**С версии:** 200.4.0`},{heading:`buildmodulejsurls`,content:`**Параметры:**`},{heading:`buildmodulejsurls`,content:"`$plugin` — Контекст модуля."},{heading:`buildmodulejsurls`,content:"**Возвращает:** `list<string>` — URL скриптов модуля."},{heading:`buildmodulecssurls`,content:`Собирает URL публичных CSS-файлов модуля с версией по mtime.`},{heading:`buildmodulecssurls`,content:`**С версии:** 200.4.1`},{heading:`buildmodulecssurls`,content:`**Параметры:**`},{heading:`buildmodulecssurls`,content:"`$plugin` — Контекст модуля."},{heading:`buildmodulecssurls`,content:"**Возвращает:** `list<string>` — URL стилей модуля (`module_css_urls` в layout)."},{heading:`buildmoduleasseturls`,content:"Общий сборщик URL файлов из `Public/` модуля."},{heading:`buildmoduleasseturls`,content:`**С версии:** 200.4.1`},{heading:`buildmoduleasseturls`,content:`**Параметры:**`},{heading:`buildmoduleasseturls`,content:"`$plugin` — Контекст модуля."},{heading:`buildmoduleasseturls`,content:"`$files` — Имена файлов относительно Public/."},{heading:`buildmoduleasseturls`,content:"**Возвращает:** `list<string>` — URL с `?v=` по mtime."},{heading:`buildtranslationjsurl`,content:`Формирует URL JS-файла переводов DevCraft для локали.`},{heading:`buildtranslationjsurl`,content:`**С версии:** 200.4.0`},{heading:`buildtranslationjsurl`,content:`**Параметры:**`},{heading:`buildtranslationjsurl`,content:"`$locale` — Код локали DevCraft."},{heading:`buildtranslationjsurl`,content:"**Возвращает:** `string` — URL с параметром версии."},{heading:`buildmetroi18nurl`,content:`Формирует URL локали Metro UI или null, если addon отсутствует.`},{heading:`buildmetroi18nurl`,content:`**С версии:** 200.4.0`},{heading:`buildmetroi18nurl`,content:`**Параметры:**`},{heading:`buildmetroi18nurl`,content:"`$metroLocale` — Код локали Metro."},{heading:`buildmetroi18nurl`,content:"**Возвращает:** `string|null` — URL JS-локали или null."},{heading:`layoutwrap`,content:`Оборачивает содержимое страницы в общий layout админки.`},{heading:`layoutwrap`,content:`**С версии:** 200.4.0`},{heading:`layoutwrap`,content:`**Параметры:**`},{heading:`layoutwrap`,content:"`$contentView` — Ключ шаблона страницы."},{heading:`layoutwrap`,content:"`$adminContext` — Контекст админки."},{heading:`layoutwrap`,content:"`$version` — Версия модуля для layout."},{heading:`layoutwrap`,content:"**Возвращает:** `string` — HTML layout."}],headings:[{id:`краткое-содержание`,content:`Краткое содержание:`},{id:`свойства`,content:`Свойства`},{id:`методы`,content:`Методы`},{id:`подробности`,content:`Подробности`},{id:`детали`,content:`Детали`},{id:`методы-1`,content:`Методы`},{id:`dispatch`,content:`dispatch()`},{id:`buildmodulejsurls`,content:`buildModuleJsUrls()`},{id:`buildmodulecssurls`,content:`buildModuleCssUrls()`},{id:`buildmoduleasseturls`,content:`buildModuleAssetUrls()`},{id:`buildtranslationjsurl`,content:`buildTranslationJsUrl()`},{id:`buildmetroi18nurl`,content:`buildMetroI18nUrl()`},{id:`layoutwrap`,content:`layoutWrap()`}]},s=[{depth:2,url:`#краткое-содержание`,title:(0,n.jsx)(n.Fragment,{children:`Краткое содержание:`})},{depth:3,url:`#свойства`,title:(0,n.jsx)(n.Fragment,{children:`Свойства`})},{depth:3,url:`#методы`,title:(0,n.jsx)(n.Fragment,{children:`Методы`})},{depth:3,url:`#подробности`,title:(0,n.jsx)(n.Fragment,{children:`Подробности`})},{depth:2,url:`#детали`,title:(0,n.jsx)(n.Fragment,{children:`Детали`})},{depth:3,url:`#методы-1`,title:(0,n.jsx)(n.Fragment,{children:`Методы`})},{depth:3,url:`#dispatch`,title:(0,n.jsx)(n.Fragment,{children:`dispatch()`})},{depth:3,url:`#buildmodulejsurls`,title:(0,n.jsx)(n.Fragment,{children:`buildModuleJsUrls()`})},{depth:3,url:`#buildmodulecssurls`,title:(0,n.jsx)(n.Fragment,{children:`buildModuleCssUrls()`})},{depth:3,url:`#buildmoduleasseturls`,title:(0,n.jsx)(n.Fragment,{children:`buildModuleAssetUrls()`})},{depth:3,url:`#buildtranslationjsurl`,title:(0,n.jsx)(n.Fragment,{children:`buildTranslationJsUrl()`})},{depth:3,url:`#buildmetroi18nurl`,title:(0,n.jsx)(n.Fragment,{children:`buildMetroI18nUrl()`})},{depth:3,url:`#layoutwrap`,title:(0,n.jsx)(n.Fragment,{children:`layoutWrap()`})}];function c(e){let t={a:`a`,code:`code`,em:`em`,h2:`h2`,h3:`h3`,hr:`hr`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.h2,{id:`краткое-содержание`,children:`Краткое содержание:`}),`
...
`,(0,n.jsxs)(t.li,{children:[`private `,(0,n.jsx)(t.a,{href:`#method_buildModuleCssUrls`,children:`buildModuleCssUrls()`})]}),`
`,(0,n.jsxs)(t.li,{children:[`private `,(0,n.jsx)(t.a,{href:`#method_buildModuleAssetUrls`,children:`buildModuleAssetUrls()`})]}),`
...
`,(0,n.jsx)(`span`,{id:`method_buildModuleCssUrls`}),`
`,(0,n.jsx)(t.h3,{id:`buildmodulecssurls`,children:`buildModuleCssUrls()`}),`
`,(0,n.jsx)(t.p,{children:`Собирает URL публичных CSS-файлов модуля с версией по mtime.`}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`С версии:`}),` 200.4.1`]}),`
`,(0,n.jsx)(t.p,{children:(0,n.jsx)(t.strong,{children:`Параметры:`})}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$plugin`}),` — Контекст модуля.`]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`list<string>`}),` — URL стилей модуля (`,(0,n.jsx)(t.code,{children:`module_css_urls`}),` в layout).`]}),`
`,(0,n.jsx)(`span`,{id:`method_buildModuleAssetUrls`}),`
`,(0,n.jsx)(t.h3,{id:`buildmoduleasseturls`,children:`buildModuleAssetUrls()`}),`
`,(0,n.jsxs)(t.p,{children:[`Общий сборщик URL файлов из `,(0,n.jsx)(t.code,{children:`Public/`}),` модуля.`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`С версии:`}),` 200.4.1`]}),`
`,(0,n.jsx)(t.p,{children:(0,n.jsx)(t.strong,{children:`Параметры:`})}),`
`,(0,n.jsxs)(t.ul,{children:[`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$plugin`}),` — Контекст модуля.`]}),`
`,(0,n.jsxs)(t.li,{children:[(0,n.jsx)(t.code,{children:`$files`}),` — Имена файлов относительно Public/.`]}),`
`]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`list<string>`}),` — URL с `,(0,n.jsx)(t.code,{children:`?v=`}),` по mtime.`]}),`
