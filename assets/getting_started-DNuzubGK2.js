import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Getting started`,description:`Overview of DevCraft Dev Tools, architecture, requirements, and first steps.`,version:`1.0.1`},i=new Date(1787145028e3),a=`
...
<Cards>
  <Card title="Installation" href="/dev/dev-tools/1.0.1/en/install">
    Packagist and path repository
  </Card>

  <Card title="With attributes" href="/dev/dev-tools/1.0.1/en/guides/with_attributes">
    Fluent builders and WithHandler
  </Card>

  <Card title="Getters and setters" href="/dev/dev-tools/1.0.1/en/guides/accessors">
    lombok-php accessors on AbstractWith
  </Card>

  <Card title="Reflection mapper" href="/dev/dev-tools/1.0.1/en/guides/reflection_mapper">
    DTO hydration and serialization
  </Card>

  <Card title="Validation" href="/dev/dev-tools/1.0.1/en/guides/validation">
    Filter, Range, Regex, ArrayOf
  </Card>

  <Card title="API reference" href="/dev/dev-tools/1.0.1/reference">
    Classes, methods, and types
  </Card>

  <Card title="Changelog" href="/dev/dev-tools/1.0.1/en/changelog">
    Release history
  </Card>
</Cards>
...
* Transitive runtime: [\`marcin-orlowski/lombok-php\`](https://packagist.org/packages/marcin-orlowski/lombok-php) \`^1.2\` (installed with the package)
...
`,o={contents:[{heading:void 0,content:"Package `devcraftclub/dev-tools` is a PHP 8.3 library with two complementary capabilities:"},{heading:void 0,content:"**Fluent mutation and accessors** — `#[With]` / `#[WithItem]`, `#[Getter]` / `#[Setter]` (lombok-php), `AbstractWith`."},{heading:void 0,content:"**DTO mapping** — `AbstractReflection`, array hydration, attribute validation, `toArray()` / `toJson()`."},{heading:void 0,content:`These base classes use different property models and are **not** meant to be combined through inheritance.`},{heading:`documentation-sections`,content:`Packagist and path repository`},{heading:`documentation-sections`,content:`Fluent builders and WithHandler`},{heading:`documentation-sections`,content:`lombok-php accessors on AbstractWith`},{heading:`documentation-sections`,content:`DTO hydration and serialization`},{heading:`documentation-sections`,content:`Filter, Range, Regex, ArrayOf`},{heading:`documentation-sections`,content:`Classes, methods, and types`},{heading:`documentation-sections`,content:`Release history`},{heading:`quick-start`,content:`DTO mapping:`},{heading:`choosing-a-base-class`,content:`Need`},{heading:`choosing-a-base-class`,content:`Extend`},{heading:`choosing-a-base-class`,content:`Property style`},{heading:`choosing-a-base-class`,content:"Fluent `with*` / query objects, plus `get*` / `set*`"},{heading:`choosing-a-base-class`,content:"`AbstractWith`"},{heading:`choosing-a-base-class`,content:`Private (or protected), non-static, non-readonly`},{heading:`choosing-a-base-class`,content:`API response / request DTO`},{heading:`choosing-a-base-class`,content:"`AbstractReflection`"},{heading:`choosing-a-base-class`,content:`Public, typed, hydratable`},{heading:`choosing-a-base-class`,content:`Do not combine them through inheritance. If you need both shapes, use composition or two separate classes.`},{heading:`requirements`,content:`PHP 8.3 or newer`},{heading:`requirements`,content:`Composer`},{heading:`requirements`,content:"Transitive runtime: `marcin-orlowski/lombok-php` `^1.2` (installed with the package)"},{heading:`next-steps`,content:`Installation`},{heading:`next-steps`,content:`With attributes`},{heading:`next-steps`,content:`Getters and setters`},{heading:`next-steps`,content:`API reference`}],headings:[{id:`architecture`,content:`Architecture`},{id:`documentation-sections`,content:`Documentation sections`},{id:`quick-start`,content:`Quick start`},{id:`choosing-a-base-class`,content:`Choosing a base class`},{id:`requirements`,content:`Requirements`},{id:`next-steps`,content:`Next steps`}]},s=[{depth:2,url:`#architecture`,title:(0,n.jsx)(n.Fragment,{children:`Architecture`})},{depth:2,url:`#documentation-sections`,title:(0,n.jsx)(n.Fragment,{children:`Documentation sections`})},{depth:2,url:`#quick-start`,title:(0,n.jsx)(n.Fragment,{children:`Quick start`})},{depth:2,url:`#choosing-a-base-class`,title:(0,n.jsx)(n.Fragment,{children:`Choosing a base class`})},{depth:2,url:`#requirements`,title:(0,n.jsx)(n.Fragment,{children:`Requirements`})},{depth:2,url:`#next-steps`,title:(0,n.jsx)(n.Fragment,{children:`Next steps`})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e.components},{Card:r,Cards:i}=t;return r||u(`Card`,!0),i||u(`Cards`,!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[`Package `,(0,n.jsx)(t.code,{children:`devcraftclub/dev-tools`}),` is a PHP 8.3 library with two complementary capabilities:`]}),`
...
`]}),`
`,(0,n.jsxs)(t.p,{children:[`These base classes use different property models and are `,(0,n.jsx)(t.strong,{children:`not`}),` meant to be combined through inheritance.`]}),`
...
`,(0,n.jsxs)(i,{children:[(0,n.jsx)(r,{title:`Installation`,href:`/dev/dev-tools/1.0.1/en/install`,children:(0,n.jsx)(t.p,{children:`Packagist and path repository`})}),(0,n.jsx)(r,{title:`With attributes`,href:`/dev/dev-tools/1.0.1/en/guides/with_attributes`,children:(0,n.jsx)(t.p,{children:`Fluent builders and WithHandler`})}),(0,n.jsx)(r,{title:`Getters and setters`,href:`/dev/dev-tools/1.0.1/en/guides/accessors`,children:(0,n.jsx)(t.p,{children:`lombok-php accessors on AbstractWith`})}),(0,n.jsx)(r,{title:`Reflection mapper`,href:`/dev/dev-tools/1.0.1/en/guides/reflection_mapper`,children:(0,n.jsx)(t.p,{children:`DTO hydration and serialization`})}),(0,n.jsx)(r,{title:`Validation`,href:`/dev/dev-tools/1.0.1/en/guides/validation`,children:(0,n.jsx)(t.p,{children:`Filter, Range, Regex, ArrayOf`})}),(0,n.jsx)(r,{title:`API reference`,href:`/dev/dev-tools/1.0.1/reference`,children:(0,n.jsx)(t.p,{children:`Classes, methods, and types`})}),(0,n.jsx)(r,{title:`Changelog`,href:`/dev/dev-tools/1.0.1/en/changelog`,children:(0,n.jsx)(t.p,{children:`Release history`})})]}),`
...
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Need`}),(0,n.jsx)(t.th,{children:`Extend`}),(0,n.jsx)(t.th,{children:`Property style`})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsxs)(t.td,{children:[`Fluent `,(0,n.jsx)(t.code,{children:`with*`}),` / query objects, plus `,(0,n.jsx)(t.code,{children:`get*`}),` / `,(0,n.jsx)(t.code,{children:`set*`})]}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`AbstractWith`})}),(0,n.jsx)(t.td,{children:`Private (or protected), non-static, non-readonly`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:`API response / request DTO`}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`AbstractReflection`})}),(0,n.jsx)(t.td,{children:`Public, typed, hydratable`})]})]})]}),`
`,(0,n.jsx)(t.p,{children:`Do not combine them through inheritance. If you need both shapes, use composition or two separate classes.`}),`
...
`,(0,n.jsxs)(t.li,{children:[`Transitive runtime: `,(0,n.jsx)(t.a,{href:`https://packagist.org/packages/marcin-orlowski/lombok-php`,children:(0,n.jsx)(t.code,{children:`marcin-orlowski/lombok-php`})}),` `,(0,n.jsx)(t.code,{children:`^1.2`}),` (installed with the package)`]}),`
`]})}),`
