import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`История изменений`,description:`Changelog DLE Faker.`},i=new Date(1786541452e3),a=`

Актуальный список ведётся в модуле (\`changelog.data.php\`) и отображается на \`?mod=dle_faker&action=changelog\`.
...
`,o={contents:[{heading:void 0,content:"Актуальный список ведётся в модуле (`changelog.data.php`) и отображается на `?mod=dle_faker&action=changelog`."},{heading:`20014-2026-07-16`,content:`Миграция на DevCraft Admin / DLE 20.0`},{heading:`20014-2026-07-16`,content:`Медиа-библиотека, плейлисты video/audio, multi-random для галерей`},{heading:`20014-2026-07-16`,content:"INSERT `post_extras` без `allow_rss_turbo`; SQL-ошибки → JSON"},{heading:`20014-2026-07-16`,content:`Multipart upload через ядро DevCraft`},{heading:`18013`,content:`Последний legacy-релиз MHAdmin.`}],headings:[{id:`20014-2026-07-16`,content:`200.1.4 (2026-07-16)`},{id:`18013`,content:`180.1.3`}]},s=[{depth:2,url:`#20014-2026-07-16`,title:(0,n.jsx)(n.Fragment,{children:`200.1.4 (2026-07-16)`})},{depth:2,url:`#18013`,title:(0,n.jsx)(n.Fragment,{children:`180.1.3`})}];function c(e){let t={code:`code`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[`Актуальный список ведётся в модуле (`,(0,n.jsx)(t.code,{children:`changelog.data.php`}),`) и отображается на `,(0,n.jsx)(t.code,{children:`?mod=dle_faker&action=changelog`}),`.`]}),`
