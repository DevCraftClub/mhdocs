import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`Caveman`,description:`Skill краткой речи и MCP compress — замена sqz для длинного stdout/JSON.`},i=new Date(1789411081e3),a=`
...
В чате: \`/caveman\` (уровни lite / full / ultra — по документации upstream). Цель — меньше слов в ответах при том же диагнозе и фиксе.
...
`,(0,n.jsxs)(t.p,{children:[`В чате: `,(0,n.jsx)(t.code,{children:`/caveman`}),` (уровни lite / full / ultra — по документации upstream). Цель — меньше слов в ответах при том же диагнозе и фиксе.`]}),`
