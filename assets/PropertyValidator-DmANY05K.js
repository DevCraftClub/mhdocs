import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./jsx-runtime-By8HlURe.js";var n=e(t()),r={title:`PropertyValidator`,description:`Запуск ValidationRule-атрибутов на свойстве или объекте без гидратации.`,version:`1.0.1`},i=new Date(1787750944e3),a=`
...
| ----------- | -------------------- | ------------------------------- |
| \`$property\` | \`ReflectionProperty\` | Свойство с атрибутами-правилами |
| \`$value\`    | \`mixed\`              | Проверяемое значение            |

**Возвращает:** \`array\` — \`list<string>\` сообщений
...
| Параметр  | Тип      | Описание               |
| --------- | -------- | ---------------------- |
| \`$object\` | \`object\` | Экземпляр для проверки |

**Возвращает:** \`array\` — карта ошибок по имени свойства
...
\`\`\`
`,o={contents:[{heading:void 0,content:"**Описание:** Утилита валидации: читает атрибуты свойства, инстанцирует `ValidationRule`, собирает сообщения. Используется `ReflectionMapper` и может вызываться отдельно."},{heading:void 0,content:"**Namespace:** `Devcraft\\Validation`"},{heading:void 0,content:`**С версии:** 1.0.0`},{heading:void 0,content:`**См. также:**`},{heading:void 0,content:`ValidationRule`},{heading:void 0,content:`ReflectionMapper`},{heading:void 0,content:`Гайд: валидация`},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:"**Описание:** Возвращает `list<string>` сообщений для одного свойства. Атрибуты не из `ValidationRule` игнорируются."},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:`**Параметры:**`},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:`Параметр`},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:`Тип`},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:`Описание`},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:"`$property`"},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:"`ReflectionProperty`"},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:`Свойство с атрибутами-правилами`},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:"`$value`"},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:"`mixed`"},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:`Проверяемое значение`},{heading:`validatevaluereflectionproperty-property-mixed-value-array`,content:"**Возвращает:** `array` — `list<string>` сообщений"},{heading:`validateobjectobject-object-array`,content:"**Описание:** Возвращает `array<string, list<string>>` по имени свойства. Смотрит только public, non-static, initialized свойства."},{heading:`validateobjectobject-object-array`,content:`**Параметры:**`},{heading:`validateobjectobject-object-array`,content:`Параметр`},{heading:`validateobjectobject-object-array`,content:`Тип`},{heading:`validateobjectobject-object-array`,content:`Описание`},{heading:`validateobjectobject-object-array`,content:"`$object`"},{heading:`validateobjectobject-object-array`,content:"`object`"},{heading:`validateobjectobject-object-array`,content:`Экземпляр для проверки`},{heading:`validateobjectobject-object-array`,content:"**Возвращает:** `array` — карта ошибок по имени свойства"}],headings:[{id:`методы`,content:`Методы`},{id:`validatevaluereflectionproperty-property-mixed-value-array`,content:"`validateValue(ReflectionProperty $property, mixed $value): array`"},{id:`validateobjectobject-object-array`,content:"`validateObject(object $object): array`"}]},s=[{depth:2,url:`#методы`,title:(0,n.jsx)(n.Fragment,{children:`Методы`})},{depth:3,url:`#validatevaluereflectionproperty-property-mixed-value-array`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`validateValue(ReflectionProperty $property, mixed $value): array`})})},{depth:3,url:`#validateobjectobject-object-array`,title:(0,n.jsx)(n.Fragment,{children:(0,n.jsx)(`code`,{children:`validateObject(object $object): array`})})}];function c(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Описание:`}),` Утилита валидации: читает атрибуты свойства, инстанцирует `,(0,n.jsx)(t.code,{children:`ValidationRule`}),`, собирает сообщения. Используется `,(0,n.jsx)(t.code,{children:`ReflectionMapper`}),` и может вызываться отдельно.`]}),`
...
`,(0,n.jsx)(t.h3,{id:`validatevaluereflectionproperty-property-mixed-value-array`,children:(0,n.jsx)(t.code,{children:`validateValue(ReflectionProperty $property, mixed $value): array`})}),`
...
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Параметр`}),(0,n.jsx)(t.th,{children:`Тип`}),(0,n.jsx)(t.th,{children:`Описание`})]})}),(0,n.jsxs)(t.tbody,{children:[(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`$property`})}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`ReflectionProperty`})}),(0,n.jsx)(t.td,{children:`Свойство с атрибутами-правилами`})]}),(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`$value`})}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`mixed`})}),(0,n.jsx)(t.td,{children:`Проверяемое значение`})]})]})]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`array`}),` — `,(0,n.jsx)(t.code,{children:`list<string>`}),` сообщений`]}),`
`,(0,n.jsx)(t.h3,{id:`validateobjectobject-object-array`,children:(0,n.jsx)(t.code,{children:`validateObject(object $object): array`})}),`
...
`,(0,n.jsx)(t.p,{children:(0,n.jsx)(t.strong,{children:`Параметры:`})}),`
`,(0,n.jsxs)(t.table,{children:[(0,n.jsx)(t.thead,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.th,{children:`Параметр`}),(0,n.jsx)(t.th,{children:`Тип`}),(0,n.jsx)(t.th,{children:`Описание`})]})}),(0,n.jsx)(t.tbody,{children:(0,n.jsxs)(t.tr,{children:[(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`$object`})}),(0,n.jsx)(t.td,{children:(0,n.jsx)(t.code,{children:`object`})}),(0,n.jsx)(t.td,{children:`Экземпляр для проверки`})]})})]}),`
`,(0,n.jsxs)(t.p,{children:[(0,n.jsx)(t.strong,{children:`Возвращает:`}),` `,(0,n.jsx)(t.code,{children:`array`}),` — карта ошибок по имени свойства`]}),`
